...
from PyQt5.QtWidgets import (QAction, QActionGroup, QApplication, QButtonGroup,
                             ...
                             QMenu, QPushButton, QToolBar, QToolButton,
                             QVBoxLayout, QWidget)
...
class ToolbarAction:
    ...
    def __init__(self, action_id: str, title: str, tooltip: str,
...
class AdvancedFoldersToolbar(QObject):
    ...
    def _register_default_actions(self):
        ...
        default_actions = [
            # File operations
            ToolbarAction(
                "new_folder", "New Folder", "Create new folder configuration",
                ":/icons/folder_new.png", "Ctrl+N", group="file_ops"
            ),
            ToolbarAction(
                "edit_folder", "Edit Folder", "Edit selected folder configuration",
                ":/icons/folder_edit.png", "Ctrl+E", group="file_ops"
            ),
            ToolbarAction(
                "delete_folder", "Delete Folder", "Delete selected folder configuration",
                ":/icons/folder_delete.png", "Delete", group="file_ops"
            ),
            ToolbarAction(
                "refresh_folders", "Refresh", "Refresh folder list",
                ":/icons/refresh.png", "F5", group="file_ops"
            ),
            
            # Search operations
            ToolbarAction(
                "quick_search", "Quick Search", "Perform quick search",
                ":/icons/search.png", "Ctrl+F", group="search_ops"
            ),
            ToolbarAction(
                "advanced_search", "Advanced Search", "Open advanced search dialog",
                ":/icons/search_advanced.png", "Ctrl+Shift+F", group="search_ops"
            ),
            ToolbarAction(
                "clear_search", "Clear Search", "Clear search results",
                ":/icons/clear.png", "Ctrl+Shift+C", group="search_ops"
            ),
            ToolbarAction(
                "save_search", "Save Search", "Save current search parameters",
                ":/icons/save_search.png", "Ctrl+S", group="search_ops"
            ),
            
            # View operations
            ToolbarAction(
                "view_details", "Details View", "Show detailed file information",
                ":/icons/view_details.png", checkable=True, checked=True, group="view_mode"
            ),
            ToolbarAction(
                "view_list", "List View", "Show simple file list",
                ":/icons/view_list.png", checkable=True, group="view_mode"
            ),
            ToolbarAction(
                "view_icons", "Icons View", "Show files as icons",
                ":/icons/view_icons.png", checkable=True, group="view_mode"
            ),
            
            # Tools and utilities
            ToolbarAction(
                "export_results", "Export Results", "Export search results",
                ":/icons/export.png", "Ctrl+Alt+E", group="tools"
            ),
            ToolbarAction(
                "import_config", "Import Config", "Import folder configurations",
                ":/icons/import.png", "Ctrl+Alt+I", group="tools"
            ),
            ToolbarAction(
                "preferences", "Preferences", "Open preferences dialog",
                ":/icons/preferences.png", "Ctrl+,", group="tools"
            ),
            ToolbarAction(
                "help", "Help", "Show help documentation",
                ":/icons/help.png", "F1", group="tools"
            ),
            
            # Selection operations
            ToolbarAction(
                "select_all", "Select All", "Select all search results",
                ":/icons/select_all.png", "Ctrl+A", group="selection"
            ),
            ToolbarAction(
                "select_none", "Select None", "Clear selection",
                ":/icons/select_none.png", "Ctrl+D", group="selection"
            ),
            ToolbarAction(
                "invert_selection", "Invert Selection", "Invert current selection",
                ":/icons/select_invert.png", "Ctrl+I", group="selection"
            ),
        ]
    ...
    def _create_default_sections(self):
        ...
        sections = [
            ToolbarSection(
                "file_operations",
                "File Operations",
                [self.action_registry[aid] for aid in 
                 ["new_folder", "edit_folder", "delete_folder", "refresh_folders"]]
            ),
            ToolbarSection(
                "search_operations",
                "Search Operations",
                [self.action_registry[aid] for aid in 
                 ["quick_search", "advanced_search", "clear_search", "save_search"]]
            ),
            ToolbarSection(
                "view_modes",
                "View Modes",
            ...
            ToolbarSection(
                ...
                "Tools & Utilities",
                [self.action_registry[aid] for aid in 
                 ["export_results", "import_config", "preferences", "help"]]
            ),
        ]
    ...
    def create_quick_access_bar(self, parent_widget: QWidget) -> QFrame:
        ...
        quick_actions = ["new_folder", "refresh_folders", "quick_search", "preferences"]
        ...
        self.context_label.setStyleSheet("QLabel { color: #666666; font-size: 11px; }")
    ...
    def _create_qaction(self, action_def: ToolbarAction) -> QAction:
        ...
        if action_def.callback:
            ...
            qaction.triggered.connect(
                lambda checked, aid=action_def.action_id: 
                self.actionTriggered.emit(aid, checked)
            )
    ...
    def _create_toolbar_button(self, action_def: ToolbarAction, 
    ...
    def _update_toolbar_for_context(self, context_name: str):
        ...
        context_rules = {
            "default": {
                "visible": ["new_folder", "edit_folder", "delete_folder", "refresh_folders",
                          "quick_search", "advanced_search", "preferences", "help"],
                "enabled": ["new_folder", "refresh_folders", "quick_search", 
                          "advanced_search", "preferences", "help"]
            },
            "search_results": {
                "visible": ["clear_search", "save_search", "export_results",
                          "select_all", "select_none", "view_details", "view_list"],
                "enabled": ["clear_search", "save_search", "export_results",
                          "select_all", "select_none", "view_details", "view_list"]
            },
            "folder_selected": {
                "visible": ["edit_folder", "delete_folder", "quick_search",
                          "advanced_search", "refresh_folders"],
                "enabled": ["edit_folder", "delete_folder", "quick_search",
                          "advanced_search", "refresh_folders"]
            }
        }
    ...
    def load_toolbar_config(self):
        ...
        for action_id, action_def in self.action_registry.items():
            visible = settings.value(f"toolbar/action_{action_id}_visible", True, type=bool)
            action_def.visible = visible
        
        # Load section visibility states
        for section_id, section in self.toolbar_sections.items():
            visible = settings.value(f"toolbar/section_{section_id}_visible", True, type=bool)
