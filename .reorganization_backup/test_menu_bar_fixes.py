...
def test_tool_menu_bars():
    ...
    tools_to_test = [
        ("Image Metadata Editor", "enhanced_image_metadata_editor_with_menu", "EnhancedImageMetadataEditorGUI"),
        ("Office Metadata Editor", "enhanced_office_metadata_editor_with_menu", "EnhancedOfficeMetadataEditorGUI"),
        ("File Touch", "enhanced_file_touch_with_menu", "EnhancedFileTouchGUI"),
        ("Security Preferences", "enhanced_security_preferences_with_menu", "EnhancedSecurityPreferencesGUI"),
        # Analysis tools from src/utilities/analysis/
        ("Size Analyzer", "src.utilities.analysis.size_analyzer", "SizeAnalyzerGUI"),
        ("Duplicate Finder", "src.utilities.analysis.find_duplicate_files", "DuplicateFinderApp"),
        ("Empty Folders", "src.utilities.analysis.empty_folders", "EmptyFoldersGUI"),
        ("Checksum Calculator", "src.utilities.analysis.check_sum", "ChecksumGUI"),
        # System maintenance tool
        ("Software Maintenance", "src.utilities.system.software_maintenance.gui.maintenance_hub", "SoftwareMaintenanceHub"),
    ]
    ...
    for tool_name, module_name, class_name in tools_to_test:
        try:
            ...
            if menu_bar and menu_bar.actions():
                ...
                results.append(f"✅ {tool_name}: Menu bar present with {menu_count} menus")
