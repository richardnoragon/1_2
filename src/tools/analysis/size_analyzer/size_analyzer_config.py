...
class SizeAnalyzerConfig:
    ...
    def __init__(self, config_manager=None):
        ...
        if LogManagerClass and hasattr(LogManagerClass, "get_logger"):
            if isinstance(LogManagerClass, type):
        ...
        self.defaults = {
            ...
            "resources": {
                "icon_path": "resources/icons/size_analyzer.png",
                "ui_file": "resources/ui/size_analyzer.ui",
                "help_file": "docs/developer/size_analyzer_help.html",
                "template_path": "resources/templates/size_analyzer",
    ...
    def get_resource_path(self, resource_name: str) -> str:
        ...
        if resource_path and not os.path.isabs(resource_path):
            ...
            base_dirs = [
                config_path.parents[4],  # project root
                config_path.parents[3],  # src directory for legacy layouts
            ]
            ...
            for base_dir in base_dirs:
                ...
                resource_path = str(base_dirs[0] / resource_path)
