...
class EncryptionLogger:
    ...
    def audit(self, event: SecurityEvent, details: Dict[str, Any] = None):
        ...
        try:
            ...
            # Log as audit level
            self.log(
                LogLevel.AUDIT, f"Security event: {event.value}", audit_entry
            )
    ...
    def log_operation_start(
        ...
        self.audit(
            SecurityEvent.OPERATION_STARTED,
            {
    ...
    def log_operation_complete(
        ...
        self.audit(
            SecurityEvent.OPERATION_COMPLETED,
            {
                "operation_id": operation_id,
    ...
    def log_key_operation(
        self, operation: str, key_path: str = None, success: bool = True
    ):
    ...
    def log_security_violation(
        ...
        self.log(
            LogLevel.CRITICAL, f"Security violation: {violation_type}", details
        )
        ...
        try:
            ...
            for filename in os.listdir(self.log_directory):
                ...
                if (
                    ...
                    and filename.startswith("encryption_")
                    and os.path.getmtime(file_path) < cutoff_time
                ):

                    os.remove(file_path)
                    self.log(
                        LogLevel.INFO, f"Cleaned up old log file: {filename}"
                    )
