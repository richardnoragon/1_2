...
try:
    ...
    from .privacy_tools.gui.privacy_hub import PrivacyToolsHub as PrivacyCleanerGUI
    print("Loaded advanced privacy tools")
except ImportError as e:
    print(f"Advanced privacy tools not available ({e}), using simplified version")
    try:
        ...
        class PrivacyCleanerGUI(QMainWindow):
            ...
            def init_ui(self):
                ...
                self.status_list.addItem("Select a tool to clean sensitive data")
                ...
                """
                for button in [cleaner_button, anonymize_button, scrubber_button,
                              wipe_button]:
