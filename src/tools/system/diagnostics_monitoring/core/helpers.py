...
def moving_average(values: List[Union[int, float]], 
...
def calculate_percentile(values: List[Union[int, float]], 
...
def validate_config_value(value: Any, 
    ...
    try:
        ...
        logger.warning(f"Invalid config value {value}, using default {default}")
        return default
