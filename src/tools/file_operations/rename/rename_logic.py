...
class FileRenamer(QObject):
    ...
    def _generate_metadata_mode_name(
        self, filepath: Union[str, Path], ext: str, date_format: Optional[str]
    ) -> str:
    ...
    def _handle_extension_modes(self, name: str, mode: str, text: str) -> str:
    ...
    def validate_rename(
        self, old_path: Union[str, Path], new_name: str
    ) -> Tuple[bool, str]:
    ...
    def rename_file(
        ...
        try:
            ...
            return RenameOperation(True, str(old_path), str(new_path), None)

        except Exception as e:
            return RenameOperation(False, str(old_path), str(new_path), str(e))
    ...
    def rename_files_batch(
        ...
        for i, filepath in enumerate(files):
            ...
            try:
                ...
                # Emit signal
                self.file_renamed.emit(filepath.name, new_name, result.success)
