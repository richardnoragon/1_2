...
class CopyMoveSyncDeleteWindow(StandardWindow):
    ...
    def _create_copy_move_tab(self):
        ...
        self.copy_move_button.setStyleSheet(f"""
            QPushButton {{
    ...
    def execute_sync(self):
        ...
        self._start_operation(
            'sync', source=source, destination=dest,
    ...
    def _set_ui_enabled(self, enabled: bool):
        ...
        browse_buttons = [
            self.browse_source_button, self.browse_dest_button,
            self.browse_sync_source_button, self.browse_sync_dest_button,
            self.browse_delete_target_button, self.browse_dir1_button,
