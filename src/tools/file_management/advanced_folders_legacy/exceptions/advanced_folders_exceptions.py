...
class MetadataException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs
        ...
        suggestion = kwargs.get('suggestion') or "Check file format and ensure it's supported for metadata extraction."
...
class CacheException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs
        ...
        suggestion = kwargs.get('suggestion') or "Clear cache or check cache storage permissions."
