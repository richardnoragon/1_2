...
class ExtractionStatistics:
    ...
    def update_stats(
        ...
        self.formats_processed[file_format] = (
            self.formats_processed.get(file_format, 0) + 1
        )
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        if not HAS_PIL:
            raise MetadataException(
                "PIL not available for image metadata extraction"
            )
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting image metadata: {str(e)}"
            )
...
class AudioMetadataExtractor(MetadataExtractor):
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        if not HAS_MUTAGEN:
            raise MetadataException(
                "Mutagen not available for audio metadata extraction"
            )
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting audio metadata: {str(e)}"
            )
...
class DocumentMetadataExtractor(MetadataExtractor):
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting document metadata: {str(e)}"
            )
    ...
    def _extract_docx_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting DOCX metadata: {str(e)}"
            )
        ...
        try:
            ...
            try:
                with open(file_path, "r", encoding="latin1") as file:
                    content = file.read()
                    metadata.update(
                        {"character_count": len(content), "encoding": "latin1"}
                    )
            except Exception:
                metadata["encoding"] = "unknown"
        except Exception as e:
            raise MetadataException(
                f"Error extracting text metadata: {str(e)}"
            )
...
class ArchiveMetadataExtractor(MetadataExtractor):
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting archive metadata: {str(e)}"
            )
        ...
        try:
            with zipfile.ZipFile(file_path, "r") as zip_file:
                ...
                total_compressed_size = sum(
                    info.compress_size for info in file_list
                )
                total_uncompressed_size = sum(
                    info.file_size for info in file_list
                )
...
class VideoMetadataExtractor(MetadataExtractor):
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting video metadata: {str(e)}"
            )
...
class BasicFileMetadataExtractor(MetadataExtractor):
    ...
    def extract_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MetadataException(
                f"Error extracting basic metadata: {str(e)}"
            )
...
class MetadataExtractionPipeline:
    ...
    def extract_metadata(
        ...
        try:
            ...
            success = False
            self.logger.warning(
                f"Metadata extraction failed for {file_path}: {str(e)}"
            )
...
def create_metadata_pipeline(
    cache_enabled: bool = True, cache_path: Optional[str] = None, **kwargs
