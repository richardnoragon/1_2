...
from PyQt5.QtWidgets import (
    ...
    QComboBox, QSpinBox, QProgressBar, QTextEdit, QTabWidget,
...
class FileRenameWindow(StandardWindow):
    ...
    def create_config_panel(self) -> QWidget:
        ...
        self.combo_mode.addItems([
            ...
            "new_name", "lower", "upper", "title", "replace",
            "sequential", "date_prefix", "date_suffix", "metadata",
            "remove_extension", "change_extension"
        ])
    ...
    def on_mode_changed(self, mode: str):
        ...
        text_required = mode in [
            'prefix', 'suffix', 'remove_prefix', 'remove_suffix',
            'new_name', 'replace', 'sequential', 'change_extension'
        ]
