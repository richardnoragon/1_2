...
from ..components.data_visualization import (
    RealTimeChart, ProgressIndicator, StatusIndicator, DataTable
)
...
class BandwidthStatisticsWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        layout.setContentsMargins(Spacing.MEDIUM_SPACING, 
...
class BandwidthMonitorWidget(StandardWindow):
    ...
    def _connect_signals(self):
        ...
        self.bandwidth_monitor.status_changed.connect(
            self._on_status_changed
        )
        self.bandwidth_monitor.data_updated.connect(
            self._on_data_updated
        )
        self.bandwidth_monitor.error_occurred.connect(
