...
try:
    ...
    from ..models.enhanced_file_model import (
    ...
    class BasePaneWidget(QFrame if QT_AVAILABLE else object):
        ...
        def __init__(self, config, parent=None):
            ...
            self.logger = logging.getLogger(
                "RFU.FileExplorer.BasePaneWidget.Fallback"
            )
...
class FileExplorerDelegate(QStyledItemDelegate if QT_AVAILABLE else object):
    ...
    def __init__(self, parent=None):
        ...
        self.logger = logging.getLogger(
            "RFU.FileExplorer.FileExplorerDelegate"
        )
        ...
        self.selection_color = (
            QColor(100, 150, 200, 100) if QT_AVAILABLE else None
        )
    ...
    def _draw_text(self, painter, text, rect, option):
        ...
        painter.drawText(
            rect, Qt.AlignLeft | Qt.AlignVCenter | Qt.TextSingleLine, text
        )
    ...
    def _draw_details(self, painter, text, rect, option):
        ...
        painter.drawText(
            rect, Qt.AlignLeft | Qt.AlignTop | Qt.TextSingleLine, text
        )
...
class NavigationBar(QFrame if QT_AVAILABLE else object):
    ...
    def _create_address_section(self, layout):
        ...
        self.breadcrumb_widget.mouseDoubleClickEvent = (
            self._switch_to_address_bar
        )
    ...
    def _update_breadcrumbs(self):
        ...
        try:
            ...
            if parts and parts[0]:
                root_button = self._create_breadcrumb_button(
    ...
    def _update_navigation_buttons(self):
        ...
        if self.up_button:
            try:
                has_parent = Path(self.current_path).parent != Path(
                    self.current_path
                )
...
class FileListWidget(QTreeView if QT_AVAILABLE else object):
    ...
    def _setup_connections(self):
        ...
        try:
            ...
            # Model signals
            if self.file_model:
                self.file_model.directoryLoadFinished.connect(
    ...
    def set_sort_criteria(
        self, criteria: SortCriteria, ascending: bool = True
    ):
        """
        ...
        try:
            ...
            self.logger.debug(
                f"Sort criteria set to: {criteria.name} ({'ASC' if ascending else 'DESC'})"
            )
...
class FileExplorerPane(BasePaneWidget):
    ...
    def _create_view_controls(self, layout):
        ...
        details_btn.clicked.connect(
            lambda: self.set_view_mode(ViewMode.DETAILS)
        )
    ...
    def _connect_signals(self):
        ...
        if self.navigation_bar:
            ...
            self.navigation_bar.navigationRequested.connect(
            ...
            if self.file_list and self.file_list.model():
                ...
                if selected_count > 0:
                    self.file_count_label.setText(
                        f"{selected_count} of {file_count} selected"
                    )
                else:
