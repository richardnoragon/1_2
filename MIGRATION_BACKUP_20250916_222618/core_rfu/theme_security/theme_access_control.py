...
class AccessResult:
    ...
    def __init__(self, allowed: bool, reason: str = None,
                 user_id: str = None, operation: str = None):
...
class ThemeAccessController:
    ...
    def __init__(self, database_path: str = "data/theme_security.db"):
        ...
        self.default_permissions = {
            'admin': [
                ...
                Permission.ADMIN, Permission.BACKUP, Permission.RESTORE
            ],
            'user': [Permission.READ, Permission.WRITE],
            'guest': [Permission.READ],
            'backup_operator': [
                Permission.READ, Permission.BACKUP, Permission.RESTORE
            ]
        }
    ...
    def check_permission(self, user_id: str, permission: Permission, 
                        resource: str = None) -> AccessResult:
        """
    ...
    def log_access(self, user_id: str, operation: OperationType, 
                   resource: str = None, success: bool = True, 
                   reason: str = None, session_id: str = None) -> bool:
        """
    ...
    def grant_permission(self, user_id: str, permission: Permission,
                        resource: str = None, granted_by: str = None,
    ...
    def create_user_role(self, user_id: str, role: str, 
        ...
        try:
            ...
            for permission in self.default_permissions[role]:
                if not self.grant_permission(user_id, permission, 
