...
try:
    from src.rfu.file_explorer.features.bookmark_manager import BookmarkManager
    from src.rfu.file_explorer.features.color_scheme_manager import \
        ColorSchemeManager
    from src.rfu.file_explorer.features.search_engine import SearchEngine
    from src.rfu.file_explorer.features.view_modes import ViewModeManager
...
class TestSearchEngine:
    ...
    def test_filename_search(self, search_engine, temp_dir):
        ...
        from src.rfu.file_explorer.features.search_engine import (
...
class TestViewModeManager:
    ...
    def test_view_mode_switching(self, view_manager):
        ...
        from src.rfu.file_explorer.features.view_modes import ViewMode
    ...
    def test_view_configuration(self, view_manager):
        ...
        from src.rfu.file_explorer.features.view_modes import (
...
class TestIntegration:
    ...
    def test_performance_integration(self, integrated_system):
        ...
        # Search operations
        search_engine = components['search_engine']
        from src.rfu.file_explorer.features.search_engine import SearchCriteria
