...
class FileTouchWindow(BaseWindow):
    ...
    def save_profile(self) -> None:
        ...
        if not all(hasattr(self, attr) for attr in ['accessTimeEdit', 'modificationTimeEdit', 'creationTimeEdit']):
    ...
    def apply_changes(self) -> None:
        ...
        try:
            ...
            if not all(hasattr(self, attr) for attr in ['accessTimeEdit', 'modificationTimeEdit']):
