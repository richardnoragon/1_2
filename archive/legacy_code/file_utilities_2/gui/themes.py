...
# Theme Management
class ThemeManager:
    """Manager for applying themes consistently with responsive design."""
    ...
    def set_theme(cls, theme_name):
        """Set current theme and notify all registered callbacks."""
    ...
    def apply_main_window_theme(window):
        """Apply main window theme to a QMainWindow with responsive design."""
        ...
        ThemeManager._setup_responsive_window(window)
    
    @staticmethod
    def apply_utility_window_theme(window):
        """Apply utility window theme with responsive design."""
        window.setMinimumSize(
    ...
    @staticmethod
    def _setup_responsive_window(window):
        """Setup responsive window behavior."""
        # Enable window resizing with proper constraints
