...
DEPRECATION WARNING: This module is deprecated and maintained for backward compatibility only.
Please use the new file_utilities_2 package instead:
...
- Better separation of concerns (core logic vs GUI)
- Modern PyQt5 architecture with progress tracking
- Integration with StandardWindow and ThemeManager
...
class SizeAnalyzerWindow(BaseWindow):
    ...
    def __init__(self) -> None:
        ...
        DEPRECATION WARNING: SizeAnalyzerWindow is deprecated.
        Please use SizeAnalyzerGUI from file_utilities_2.gui.size_analyzer_gui instead.
...
def main() -> None:
    ...
    DEPRECATION WARNING: This main function is deprecated.
    Please use the new SizeAnalyzerGUI from file_utilities_2 package instead.
    ...
    """
    # Issue deprecation warning for main function usage
    warnings.warn(
