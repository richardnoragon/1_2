...
class SimpleSystemInfoGUI(QMainWindow):
    ...
    def _display_info(self, info):
        ...
        if 'error' in info:
            QMessageBox.warning(self, "Error", f"Failed to collect system info: {info['error']}")
            return
    ...
    def _export_info(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Export Successful", f"System information exported to:\n{filepath}")
        except Exception as e:
            QMessageBox.warning(self, "Export Failed", f"Failed to export system information:\n{str(e)}")
