...
class BaseExporter(ABC):
    ...
    def _format_date(self, date: datetime, format_str: str = "%Y-%m-%d %H:%M:%S") -> str:
    ...
    def _create_export_metadata(self, catalog_data) -> Dict[str, Any]:
        ...
        return {
            ...
            'source_directory': str(catalog_data.source_directory) if catalog_data.source_directory else None,
    ...
    def _get_file_type_icon(self, file_type) -> str:
        ...
        return icons.get(file_type.value if hasattr(file_type, 'value') else str(file_type), '❓')