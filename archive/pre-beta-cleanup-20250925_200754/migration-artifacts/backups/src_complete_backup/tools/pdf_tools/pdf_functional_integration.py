...
class PDFFunctionalIntegration:
    ...
    def merge_pdfs_functional(self):
        ...
        try:
            ...
            invalid_files = [f for f, v in validation_results.items() 
                           if not v['valid_pdf']]
    ...
    def sign_pdf_functional(self):
        ...
        try:
            ...
            self.start_pdf_operation(
                ...
                input_file, signature_file, output_file, options
            )
    ...
    def extract_images_functional(self):
        ...
        try:
            ...
            self.logger.error(f"Error in image extraction operation: {e}", exc_info=True)
            QMessageBox.critical(
                self.parent_widget,
    ...
    def extract_metadata_functional(self):
        ...
        try:
            ...
            self.logger.error(f"Error in metadata extraction operation: {e}", exc_info=True)
            QMessageBox.critical(
                self.parent_widget,
    ...
    def extract_tables_functional(self):
        ...
        try:
            ...
            self.logger.error(f"Error in table extraction operation: {e}", exc_info=True)
            QMessageBox.critical(
                self.parent_widget,
    ...
    def start_pdf_operation(self, operation_name: str, operation_func, *args, **kwargs):
        ...
        try:
            ...
            self.current_operation_thread = PDFOperationThread(operation_func, *args, **kwargs)
    ...
    def on_operation_completed(self, result: OperationResult):
        ...
        try:
            ...
            self.logger.error(f"Error handling operation completion: {e}", exc_info=True)
    ...
    def show_operation_error(self, result: OperationResult):
        ...
        try:
            ...
            self.logger.error(f"{operation_name} operation failed: {result.error_message}")
    ...
    def encrypt_pdf_functional(self):
        ...
        try:
            ...
            input_file, _ = QFileDialog.getOpenFileName(
                self.parent_widget, "Select PDF to Encrypt", 
                "", "PDF files (*.pdf)"
            )
            ...
            output_file, _ = QFileDialog.getSaveFileName(
                self.parent_widget, "Save Encrypted PDF", 
            ...
            # Perform encryption
            result = self.pdf_security_engine.encrypt_pdf(input_file, output_file, settings)
            ...
            QMessageBox.critical(
                self.parent_widget, "Encryption Error",
    ...
    def decrypt_pdf_functional(self):
        ...
        try:
            ...
            from PyQt5.QtWidgets import QFileDialog
            input_file, _ = QFileDialog.getOpenFileName(
                self.parent_widget, "Select PDF to Decrypt", 
                "", "PDF files (*.pdf)"
            )
            ...
            # Get output file
            output_file, _ = QFileDialog.getSaveFileName(
                self.parent_widget, "Save Decrypted PDF", 
            ...
            # Perform decryption
            result = self.pdf_security_engine.decrypt_pdf(input_file, output_file, password)
            ...
            QMessageBox.critical(
                self.parent_widget, "Decryption Error",
    ...
    def sign_digital_pdf_functional(self):
        ...
        try:
            ...
            from PyQt5.QtWidgets import QFileDialog
            input_file, _ = QFileDialog.getOpenFileName(
                self.parent_widget, "Select PDF to Sign",
                "", "PDF files (*.pdf)"
            )
            ...
            # Get output file
            output_file, _ = QFileDialog.getSaveFileName(
                self.parent_widget, "Save Signed PDF",
            ...
            QMessageBox.critical(
                self.parent_widget, "Signing Error",
    ...
    def get_security_info_functional(self):
        ...
        try:
            ...
            from PyQt5.QtWidgets import QFileDialog
            input_file, _ = QFileDialog.getOpenFileName(
                self.parent_widget, "Select PDF to Analyze", 
                "", "PDF files (*.pdf)"
            )
            ...
            if result.success:
                ...
                QMessageBox.critical(
                    self.parent_widget, "Security Analysis Error",
            ...
            QMessageBox.critical(
                self.parent_widget, "Analysis Error",
    ...
    def add_watermark_functional(self):
        ...
        try:
            ...
            if not input_file:
                from PyQt5.QtWidgets import QFileDialog
                input_file, _ = QFileDialog.getOpenFileName(
                    self.parent_widget, "Select PDF for Watermark",
                    "", "PDF files (*.pdf)"
                )
            ...
            if pages_edit.text().strip():
                try:
                    ...
                    QMessageBox.warning(
                        self.parent_widget, "Invalid Pages",
            ...
            if success:
                ...
                QMessageBox.information(
                    self.parent_widget, "Watermark Complete",
                ...
                QMessageBox.critical(
                    self.parent_widget, "Watermark Failed",
            ...
            QMessageBox.critical(
                self.parent_widget, "Watermark Error",
    ...
    def perform_ocr_functional(self):
        ...
        try:
            ...
            if not input_file:
                from PyQt5.QtWidgets import QFileDialog
                input_file, _ = QFileDialog.getOpenFileName(
                    self.parent_widget, "Select PDF for OCR",
                    "", "PDF files (*.pdf)"
                )
    ...
    def highlight_content_functional(self):
        ...
        try:
            ...
            if not input_file:
                from PyQt5.QtWidgets import QFileDialog
                input_file, _ = QFileDialog.getOpenFileName(
                    self.parent_widget, "Select PDF for Highlighting",
                    "", "PDF files (*.pdf)"
                )
            ...
            if action != 'Remove' and not search_text:
                QMessageBox.warning(
                    self.parent_widget, "Missing Search Text",
            ...
            if success:
                QMessageBox.information(
                    self.parent_widget, "Highlighting Complete",
                ...
                QMessageBox.critical(
                    self.parent_widget, "Highlighting Failed",
            ...
            QMessageBox.critical(
                self.parent_widget, "Highlighting Error",
    ...
    def convert_to_docx_functional(self):
        ...
        try:
            ...
            if not input_file:
                input_file, _ = QFileDialog.getOpenFileName(
                    self.parent_widget, "Select PDF to Convert", 
                    "", "PDF files (*.pdf)"
                )
            ...
            try:
                ...
                if success:
                    QMessageBox.information(
                        self.parent_widget, "Conversion Complete",
                    ...
                    QMessageBox.critical(
                        self.parent_widget, "Conversion Failed",
            ...
            QMessageBox.critical(
                self.parent_widget, "Conversion Error",
    ...
    def convert_to_image_functional(self):
        ...
        try:
            ...
            if pages_edit.text().strip():
                try:
                    pages = tuple(int(p.strip()) - 1 for p in pages_edit.text().split(','))
                except ValueError:
                    QMessageBox.warning(
                        self.parent_widget, "Invalid Pages",
                        "Invalid page format. Use comma-separated numbers."
            ...
            try:
                ...
                progress.close()
                success = self._convert_to_image_fallback(input_file, output_dir, pages, image_format, dpi)
    ...
    def convert_html_to_pdf_functional(self):
        ...
        try:
            ...
            if not output_file:
                QMessageBox.warning(
                    self.parent_widget, "Invalid Output",
            ...
            try:
                ...
                if current_tab == 0:  # URL
                    ...
                    if not url:
                        progress.close()
                        QMessageBox.warning(
                            self.parent_widget, "Invalid URL",
                    ...
                    if not input_file or not os.path.exists(input_file):
                        progress.close()
                        QMessageBox.warning(
                            self.parent_widget, "Invalid File",
                    ...
                    if not html_content.strip():
                        progress.close()
                        QMessageBox.warning(
                            self.parent_widget, "Invalid Content",
                ...
                progress.close()
                QMessageBox.critical(
                    self.parent_widget, "Missing Dependencies",
    ...
    def view_pdf_functional(self):
        ...
        try:
            ...
            if not input_file:
                input_file, _ = QFileDialog.getOpenFileName(
                    self.parent_widget, "Select PDF to View", 
                    "", "PDF files (*.pdf)"
                )
            ...
            try:
                ...
                def patched_import(name, *args, **kwargs):
                    if name == 'QtWidgets' and 'view' in str(kwargs.get('fromlist', [])):
                ...
                if hasattr(self.pdf_viewer_window, 'doc') and self.pdf_viewer_window.doc:
                ...
                QMessageBox.critical(
                    self.parent_widget, "Viewer Error",
    ...
    def analyze_pdf_functional(self):
        ...
        try:
            ...
            metadata_check = QCheckBox("Extract metadata (author, title, creation date)")
            ...
            try:
                ...
                self._analyze_pdf_fallback(input_file, extract_metadata, extract_text, 
                                         analyze_structure, analyze_images)
            except Exception as analysis_error:
                progress.close()
                self.logger.error(f"PDF analysis error: {analysis_error}", exc_info=True)
                QMessageBox.critical(
                    self.parent_widget, "Analysis Error",
    ...
    def _add_watermark_fallback(self, input_file, watermark_text, pages=None, opacity=0.5):
    ...
    def _perform_ocr_fallback(self, input_file, search_text=None, action="Highlight", 
                             pages=None, generate_output=True):
        """Fallback OCR implementation with basic functionality"""
        try:
            # Create a simple message about OCR functionality
            QMessageBox.information(
                self.parent_widget, "OCR Information",
    ...
    def _highlight_content_fallback(self, input_file, search_text, action="Highlight",
                                   color="yellow", opacity=0.8, pages=None):
    ...
    def _convert_to_docx_fallback(self, input_file, output_file, pages=None):
        ...
        try:
            QMessageBox.information(
                self.parent_widget, "Conversion Information",
    ...
    def _convert_to_image_fallback(self, input_file, output_dir, pages=None, image_format="png", dpi=300):
        ...
        try:
            ...
            for page_num in page_range:
                if page_num < len(pdf):
                    ...
                    # Save image
                    output_file = os.path.join(output_dir, f"page_{page_num + 1}.{image_format}")
    ...
    def _analyze_pdf_fallback(self, input_file, extract_metadata=True, extract_text=True,
                             analyze_structure=True, analyze_images=False):
    ...
    def _show_analysis_results(self, results, input_file):
        ...
        try:
            ...
            if 'total_text_length' in results:
                ...
                avg_words_per_page = results['word_count'] / results.get('page_count', 1)
            ...
            QMessageBox.information(
                self.parent_widget, "Analysis Complete",
...
def integrate_functional_pdf_operations(enhanced_pdf_widget):
    ...
    try:
        ...
        enhanced_pdf_widget._extract_metadata_impl = integration.extract_metadata_functional
        ...
        enhanced_pdf_widget._view_pdf_impl = (
            integration.view_pdf_functional
        )
        ...
        logger.error(f"Failed to integrate functional PDF operations: {e}", exc_info=True)
        return False
