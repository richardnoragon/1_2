...
class BrowserDetector:
    ...
    def _check_macos_browser(self, browser: str) -> bool:
        ...
        if browser == DataLocations.CHROME:
            return (applications / "Google Chrome.app").exists() or \
                   (app_support / "Google" / "Chrome").exists()
                   
        elif browser == DataLocations.FIREFOX:
            return (applications / "Firefox.app").exists() or \
                   (app_support / "Firefox").exists()
            ...
            return (applications / "Microsoft Edge.app").exists() or \
                   (app_support / "Microsoft Edge").exists()
    ...
    def _check_linux_browser(self, browser: str) -> bool:
        ...
        if browser == DataLocations.CHROME:
            return (config_dir / "google-chrome").exists() or \
                   self._check_command_exists("google-chrome")
                   
        elif browser == DataLocations.FIREFOX:
            return (home / ".mozilla" / "firefox").exists() or \
                   self._check_command_exists("firefox")
                   
        elif browser == DataLocations.EDGE:
            return (config_dir / "microsoft-edge").exists() or \
                   self._check_command_exists("microsoft-edge")
