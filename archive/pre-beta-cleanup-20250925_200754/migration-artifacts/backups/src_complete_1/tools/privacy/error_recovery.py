...
class PrivacyToolsErrorRecovery:
    ...
    def _handle_module_not_found(self, error: ModuleNotFoundError, context: str) -> Optional[Any]:
    ...
    def _handle_attribute_error(self, error: AttributeError, context: str) -> Optional[Any]:
