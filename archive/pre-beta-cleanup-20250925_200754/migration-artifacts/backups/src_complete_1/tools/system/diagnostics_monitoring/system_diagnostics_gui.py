...
class SystemDiagnosticsGUI(QMainWindow):
    ...
    def create_header_section(self) -> QWidget:
        ...
        try:
            ...
            desc_label = QLabel("Comprehensive system health monitoring and diagnostics")
    ...
    def start_monitoring(self):
        ...
        try:
            ...
            self.show_error_message("Monitoring Error", f"Failed to start monitoring: {str(e)}")
    ...
    def stop_monitoring(self):
        ...
        try:
            ...
            self.show_error_message("Monitoring Error", f"Failed to stop monitoring: {str(e)}")
    ...
    def update_all_widgets(self):
        ...
        try:
            if self.monitoring_active:
                ...
                if self.performance_widget and hasattr(self.performance_widget, 'update_display'):
                ...
                self.tool_progress_updated.emit("System Diagnostics", 100, "Data updated")
    ...
    def refresh_all_data(self):
        ...
        try:
            ...
            self.show_error_message("Refresh Error", f"Failed to refresh data: {str(e)}")
...
def create_system_diagnostics_gui(hub_instance=None) -> Optional[SystemDiagnosticsGUI]:
