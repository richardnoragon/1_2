...
try:
    ...
    from PyQt5.QtWidgets import (QApplication, QMainWindow, QVBoxLayout, 
                                ...
                                QGroupBox, QProgressBar, QTreeWidget,
                                QTreeWidgetItem, QSplitter, QCheckBox,
                                QSpinBox, QComboBox, QMenuBar, QMenu,
                                QAction, QStatusBar, QFrame)
...
class DevHub(QtWidgets.QMainWindow):
    ...
    def _init_gui(self):
        ...
        self.setWindowTitle("RFU Development Hub - Enhanced Debugging & Diagnostics")
