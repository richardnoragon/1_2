...
from PyQt5.QtCore import (QAbstractItemModel, QMimeData, QModelIndex, QObject,
                          Qt, QThread, QTimer, QVariant, pyqtSignal)
from PyQt5.QtGui import QDrag, QFont, QIcon, QPainter, QPixmap
from PyQt5.QtWidgets import (QAbstractItemView, QAction, QApplication, QFrame,
...
class FolderTreeNode:
    ...
    def __init__(self, folder_config: Optional[FolderConfiguration] = None,
...
class FolderTreeModel(QAbstractItemModel):
    ...
    def data(self, index: QModelIndex, role: int = Qt.DisplayRole) -> Any:
        ...
        if role == Qt.DisplayRole:
            ...
            if node.folder_config:
                return (f"Name: {node.folder_config.name}\n"
    ...
    def _get_folder_icon(self, folder_config: FolderConfiguration) -> QIcon:
        ...
        icon_path = icon_map.get(folder_config.folder_type.value, 
                                ":/icons/folder_default.png")
    ...
    def update_folder_configuration(self, folder_config: FolderConfiguration):
        ...
        self.logger.warning(f"Folder configuration not found for update: {folder_config.id}")
    
    def get_folder_configuration(self, index: QModelIndex) -> Optional[FolderConfiguration]:
...
class FolderTreeView(QTreeView):
    ...
    def _show_context_menu(self, position):
        ...
        if folder_config:
            ...
            activate_action = QAction("Activate" if not folder_config.is_active else "Deactivate", self)
    ...
    def _toggle_folder_activation(self, folder_id: str):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", f"Failed to toggle folder activation: {e}")
    ...
    def _confirm_delete_folder(self, folder_id: str):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", f"Failed to delete folder configuration: {e}")
...
class FolderTreeWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.status_label.setStyleSheet("QLabel { color: #666666; font-size: 11px; }")
    ...
    def _connect_signals(self):
        ...
        self.tree_view.folderConfigurationRequested.connect(self.folderConfigurationRequested)
