...
class AdvancedFoldersMenuManager(QObject):
    ...
    def _register_default_menus(self):
        ...
        file_menu = MenuDefinition(
            "file", "File", [
                MenuItemDefinition(
                    "new_folder", "New Folder Configuration...",
                    "Create a new folder configuration",
                    ":/icons/folder_new.png", "Ctrl+N"
                ),
                MenuItemDefinition(
                    "open_folder", "Open Folder Configuration...",
                    "Open an existing folder configuration",
                    ":/icons/folder_open.png", "Ctrl+O"
                ),
        ...
        edit_menu = MenuDefinition(
            "edit", "Edit", [
                MenuItemDefinition(
                    ...
                    ":/icons/undo.png", "Ctrl+Z", enabled=False
                ),
                MenuItemDefinition(
                    "redo", "Redo", "Redo last undone action",
                    ":/icons/redo.png", "Ctrl+Y", enabled=False
                ),
                MenuItemDefinition("separator1", "", separator_after=True),
                MenuItemDefinition(
                    "cut", "Cut", "Cut selected items",
                    ":/icons/cut.png", "Ctrl+X", enabled=False
                ),
                MenuItemDefinition(
                    "copy", "Copy", "Copy selected items",
                    ":/icons/copy.png", "Ctrl+C", enabled=False
                ),
                MenuItemDefinition(
                    "paste", "Paste", "Paste items from clipboard",
                    ":/icons/paste.png", "Ctrl+V", enabled=False
                ),
                MenuItemDefinition("separator2", "", separator_after=True),
                MenuItemDefinition(
                    "select_all", "Select All", "Select all items",
                    ":/icons/select_all.png", "Ctrl+A"
                ),
                MenuItemDefinition(
                    "select_none", "Select None", "Clear selection",
                    ":/icons/select_none.png", "Ctrl+D"
                ),
                MenuItemDefinition(
                    "invert_selection", "Invert Selection", "Invert selection",
                    ":/icons/select_invert.png", "Ctrl+Shift+I"
                ),
                MenuItemDefinition("separator3", "", separator_after=True),
                MenuItemDefinition(
                    "find", "Find...", "Find files and folders",
                    ":/icons/find.png", "Ctrl+F"
                ),
                MenuItemDefinition(
                    "find_next", "Find Next", "Find next match",
                    ":/icons/find_next.png", "F3", enabled=False
                ),
                MenuItemDefinition(
                    "find_previous", "Find Previous", "Find previous match",
                    ":/icons/find_previous.png", "Shift+F3", enabled=False
                ),
                MenuItemDefinition("separator4", "", separator_after=True),
                MenuItemDefinition(
                    "preferences", "Preferences...", "Open preferences dialog",
                    ":/icons/preferences.png", "Ctrl+,"
                ),
            ]
        )
        ...
        view_menu = MenuDefinition(
            "view", "View", [
                MenuItemDefinition(
                    "view_mode", "View Mode", "Select view mode",
                    submenu_items=[
                        MenuItemDefinition(
                            "view_details", "Details", "Show detailed view",
                            ":/icons/view_details.png", checkable=True, checked=True
                        ),
                        MenuItemDefinition(
                            "view_list", "List", "Show list view",
                            ":/icons/view_list.png", checkable=True
                        ),
                        MenuItemDefinition(
                            "view_icons", "Icons", "Show icon view",
                            ":/icons/view_icons.png", checkable=True
                        ),
                    ]
                ),
                MenuItemDefinition("separator1", "", separator_after=True),
                MenuItemDefinition(
                    "show_toolbar", "Show Toolbar", "Toggle toolbar visibility",
                ...
                MenuItemDefinition(
                    "show_quick_access", "Show Quick Access Bar",
                ...
                MenuItemDefinition(
                    ...
                    ":/icons/refresh.png", "F5"
                ),
                MenuItemDefinition(
                    "refresh_all", "Refresh All", "Refresh all views",
                    ":/icons/refresh_all.png", "Ctrl+F5"
                ),
                MenuItemDefinition("separator4", "", separator_after=True),
                MenuItemDefinition(
                    "zoom_in", "Zoom In", "Increase font size",
                    ":/icons/zoom_in.png", "Ctrl++"
                ),
                MenuItemDefinition(
                    "zoom_out", "Zoom Out", "Decrease font size",
                    ":/icons/zoom_out.png", "Ctrl+-"
                ),
                MenuItemDefinition(
                    "zoom_reset", "Reset Zoom", "Reset font size to default",
                    ":/icons/zoom_reset.png", "Ctrl+0"
                ),
            ]
        )
        ...
        search_menu = MenuDefinition(
            "search", "Search", [
                MenuItemDefinition(
                    ...
                    ":/icons/search.png", "Ctrl+F"
                ),
                MenuItemDefinition(
                    "advanced_search", "Advanced Search...",
                    "Open advanced search dialog",
                    ":/icons/search_advanced.png", "Ctrl+Shift+F"
                ),
                MenuItemDefinition("separator1", "", separator_after=True),
                MenuItemDefinition(
                    "search_in_folder", "Search in Folder...",
                    "Search within selected folder",
                    ":/icons/search_folder.png", "Ctrl+Alt+F"
                ),
                MenuItemDefinition(
                ...
                MenuItemDefinition("separator2", "", separator_after=True),
                MenuItemDefinition(
                    "save_search", "Save Search...", "Save current search",
                    ":/icons/save_search.png", "Ctrl+S"
                ),
                MenuItemDefinition(
                    "load_search", "Load Search...", "Load saved search",
                    ":/icons/load_search.png", "Ctrl+L"
                ),
                MenuItemDefinition("separator3", "", separator_after=True),
                MenuItemDefinition(
                    "clear_search", "Clear Search", "Clear search results",
                    ":/icons/clear.png", "Ctrl+Shift+C"
                ),
                MenuItemDefinition(
                    "search_history", "Search History...",
                    "View search history",
                    ":/icons/history.png", "Ctrl+H"
                ),
            ]
        )
        ...
        tools_menu = MenuDefinition(
            "tools", "Tools", [
                MenuItemDefinition(
                    "analyze_folder", "Analyze Folder Size...",
                ...
                MenuItemDefinition(
                    "cleanup_empty", "Clean Up Empty Folders...",
                ...
                MenuItemDefinition("separator2", "", separator_after=True),
                MenuItemDefinition(
                    "validate_folders", "Validate Folder Configurations",
                ...
                MenuItemDefinition(
                    "customize_menus", "Customize Menus...",
        ...
        help_menu = MenuDefinition(
            "help", "Help", [
                MenuItemDefinition(
                    "help_contents", "Help Contents", "Show help documentation",
                    ":/icons/help.png", "F1"
                ),
                MenuItemDefinition(
                    "keyboard_shortcuts", "Keyboard Shortcuts",
                    "Show keyboard shortcuts reference",
                    ":/icons/keyboard.png", "Ctrl+?"
                ),
                MenuItemDefinition(
        ...
        # Register all menus
        for menu_def in [file_menu, edit_menu, view_menu, search_menu, 
    ...
    def create_menu_bar(self, parent_widget: QWidget) -> QMenuBar:
        ...
        sorted_menus = sorted(self.menu_definitions.values(),
    ...
    def _create_menu_action(self, item: MenuItemDefinition) -> QAction:
        ...
        if item.callback:
            ...
            action.triggered.connect(
                lambda checked, item_id=item.item_id:
                self.menuItemTriggered.emit(item_id, checked)
            )
    ...
    def create_context_menu(self, context_id: str, 
                           items: List[MenuItemDefinition]) -> QMenu:
    ...
    def load_menu_config(self):
        ...
        for item_id, item in self.menu_items.items():
            enabled = settings.value(f"menu/item_{item_id}_enabled",
                                   item.enabled, type=bool)
            item.enabled = enabled
            
            if item.checkable:
                checked = settings.value(f"menu/item_{item_id}_checked",
                                       item.checked, type=bool)
                item.checked = checked
