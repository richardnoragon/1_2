...
class RealTimeChart(QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self.title:
            ...
            painter.setFont(QFont(Fonts.DEFAULT_FAMILY, Fonts.HEADER_SIZE, Fonts.BOLD))
...
class ProgressIndicator(QWidget):
    ...
    def _setup_ui(self):
        ...
        layout.setContentsMargins(Spacing.MEDIUM_SPACING, Spacing.MEDIUM_SPACING,
                                 Spacing.MEDIUM_SPACING, Spacing.MEDIUM_SPACING)
...
class StatusIndicator(QWidget):
    ...
    def _setup_ui(self):
        ...
        layout.setContentsMargins(Spacing.SMALL_SPACING, Spacing.SMALL_SPACING,
                                 Spacing.SMALL_SPACING, Spacing.SMALL_SPACING)
        layout.setSpacing(Spacing.SMALL_SPACING)
