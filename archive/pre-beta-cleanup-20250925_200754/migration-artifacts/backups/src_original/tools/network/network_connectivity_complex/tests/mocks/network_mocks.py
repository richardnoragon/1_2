...
class MockNetworkInterface:
    ...
    def __init__(self, name: str = "eth0", is_wireless: bool = False,
                 is_up: bool = True, speed_mbps: int = 1000):
        self.name = name
...
class MockPlatformDetector:
    ...
    def get_interface_stats(self, interface_name: str) -> Optional[NetworkStats]:
...
class MockNetworkData:
    ...
    @staticmethod
    def generate_bandwidth_data(interface_name: str = "eth0", 
                               count: int = 10,
    ...
    @staticmethod
    def generate_port_scan_results(target: str = "192.168.1.1",
                                  port_range: tuple = (1, 1000)) -> Dict[str, Any]:
    ...
    def generate_wifi_networks(count: int = 5) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            networks.append({
                ...
                "frequency": random.choice([2437, 2462, 5180, 5200, 5220, 5240]),
                "signal_strength": random.randint(-80, -30),
                "security": [random.choice(security_types)],
                "encryption": random.choice(["AES", "TKIP", "WEP", "None"]),
    ...
    def generate_lan_devices(count: int = 3) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            devices.append({
                ...
                "manufacturer": random.choice(["Apple", "Dell", "HP", "Samsung"]),
                "last_seen": datetime.now() - timedelta(minutes=random.randint(1, 60)),
                "is_online": random.choice([True, False]),
                "open_ports": random.sample([22, 80, 443, 8080], random.randint(0, 3))
            })
...
class MockDeviceDiscovery:
    ...
    def start_discovery(self, interface_name: str = "eth0",
