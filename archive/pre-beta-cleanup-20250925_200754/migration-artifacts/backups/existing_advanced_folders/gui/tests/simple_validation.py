...
def test_imports():
    ...
    try:
        from tools.advanced_folders.gui.constants import (Colors, Fonts,
                                                              Layout)
...
def test_basic_instantiation():
    ...
    try:
        ...
        # Test tab creation
        try:
            from tools.advanced_folders.gui.config_tabs import \
                GeneralConfigTab
...
def test_constants_validation():
    ...
    try:
        from tools.advanced_folders.gui.constants import (Colors,
                                                              FileTypes, Fonts,
                                                              Layout)
