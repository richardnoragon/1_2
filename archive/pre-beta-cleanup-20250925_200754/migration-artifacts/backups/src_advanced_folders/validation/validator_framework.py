...
class ValidationResult:
    ...
    def add_error(self, message: str, code: str, context: Optional[Dict[str, Any]] = None):
    ...
    def add_warning(self, message: str, code: str, context: Optional[Dict[str, Any]] = None):
...
class BaseValidator(ABC):
    ...
    def __call__(self, value: Any, field_name: Optional[str] = None) -> ValidationResult:
    ...
    def validate(self, value: Any, field_name: Optional[str] = None) -> ValidationResult:
        ...
        if not isinstance(value, (str, Path)):
            result.add_error(
                ...
                "INVALID_TYPE",
                {"field": field_name, "value": value, "expected_type": "str or Path"}
            )
            return result
...
def get_all_errors(results: Dict[str, ValidationResult]) -> List[ValidationError]:
    """
