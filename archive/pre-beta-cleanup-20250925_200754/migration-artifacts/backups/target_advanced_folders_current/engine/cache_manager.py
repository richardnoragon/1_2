...
class MemoryCacheBackend(CacheBackend):
    ...
    def _evict_one(self) -> bool:
        ...
        if self.config.memory_eviction_policy == CachePolicy.LRU:
            ...
            key = min(self.frequency_counter.keys(),
...
class DiskCacheBackend(CacheBackend):
    ...
    def set(self, key: str, value: Any, ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            max_size_bytes = self.config.max_object_size_mb * 1024 * 1024
            if size_bytes > max_size_bytes:
                self.logger.warning(f"Object too large for disk cache: {size_bytes}")
                return False
            ...
            with self.lock:
                with sqlite3.connect(self.db_path) as conn:
                    ...
                    """, (
                        ...
                        ttl or self.config.disk_ttl_seconds, size_bytes
                    ))
...
class CacheInvalidationManager:
    ...
    def invalidate_by_pattern(self, pattern: str) -> int:
        ...
        self.logger.info(f"Invalidated {invalidated} entries matching '{pattern}'")
        return invalidated
...
class MultiTierCacheManager:
    ...
    def set(self, key: str, value: Any, ttl: Optional[int] = None,
        ...
        try:
            ...
            if self.distributed_cache and self.distributed_cache.set(key, value, ttl):
                success = True
    ...
    def exists(self, key: str) -> bool:
        ...
        return (self.memory_cache.exists(key) or
                (self.disk_cache and self.disk_cache.exists(key)) or
                (self.distributed_cache and self.distributed_cache.exists(key)))
