    ...
    try:
        ...
        if os.path.exists(json_report):
            try:
                ...
                print(f"\nTEST SUMMARY:")
                print(f"Total Tests: {json_data.get('summary', {}).get('total', 'N/A')}")
                print(f"Passed: {json_data.get('summary', {}).get('passed', 'N/A')}")
                print(f"Failed: {json_data.get('summary', {}).get('failed', 'N/A')}")
