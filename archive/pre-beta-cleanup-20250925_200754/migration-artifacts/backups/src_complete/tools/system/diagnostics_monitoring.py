...
class SystemDiagnosticsGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        """
        buttons = [diagnostics_button, cleanup_button, maintenance_button,
                  performance_button]
    ...
    def run_diagnostics(self):
        ...
        try:
            ...
            diagnostics_path = os.path.join(os.path.dirname(__file__),
    ...
    def run_cleanup(self):
        ...
        try:
            # Try to import and launch the actual tool
            cleanup_path = os.path.join(os.path.dirname(__file__),
                                       'system_cleanup')
    ...
    def run_maintenance(self):
        ...
        try:
            # Try to import and launch the actual tool
            maintenance_path = os.path.join(os.path.dirname(__file__),
