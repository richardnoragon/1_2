...
class SimpleRFUHub(QMainWindow):
    ...
    def create_analysis_tab(self):
        ...
        # Description
        desc = QLabel(
            "Tools for analyzing file properties, finding duplicates, and checking data integrity"
        )
        desc.setAlignment(Qt.AlignCenter)
        desc.setStyleSheet(
            f"color: {DARKER_GRAY}; margin-bottom: 15px; " f"font-size: 10px;"
        )
        ...
        for title_text, tooltip, callback in tools:
            btn = self._create_styled_tool_button(
                title_text, tooltip, callback
            )
    ...
    def create_network_tab(self):
        ...
        desc.setAlignment(Qt.AlignCenter)
        desc.setStyleSheet(
            "color: #7f8c8d; margin-bottom: 15px; font-size: 10px;"
        )
        layout.addWidget(desc)
    ...
    def _create_simple_pdf_tools_tab(self):
        ...
        # Description
        desc = QLabel(
            "PDF processing, conversion, security, and analysis tools"
        )
        desc.setAlignment(Qt.AlignCenter)
        ...
        tools = [
            (
                ...
                self.open_pdf_merger,
            ),
            (
                "✂️ PDF Splitter",
                "Split PDF into separate pages",
                self.open_pdf_splitter,
            ),
            (
                "🔄 PDF Converter",
        ...
        for i, (title_text, desc_text, callback) in enumerate(tools):
            ...
            tool_btn = self._create_styled_tool_button(
                title_text, desc_text, callback
            )
    ...
    def create_privacy_tab(self):
        ...
        # Description
        desc = QLabel(
            "Privacy protection, data cleanup, and secure browsing tools"
        )
        desc.setAlignment(Qt.AlignCenter)
        desc.setFont(QFont(SEGOE_UI_FONT, 10))
        desc.setStyleSheet(SUBTITLE_STYLE_COLOR)
        ...
        tools = [
            (
                "🧹 Privacy Cleaner",
                "Clean privacy traces and personal data",
    ...
    def create_security_tab(self):
        ...
        # Description
        desc = QLabel(
            "File encryption, secure deletion, and security analysis tools"
        )
        desc.setAlignment(Qt.AlignCenter)
        desc.setFont(QFont(SEGOE_UI_FONT, 10))
        desc.setStyleSheet(SUBTITLE_STYLE_COLOR)
        ...
        tools = [
            (
                "🔒 File Encryption",
                "Encrypt files and folders securely",
    ...
    def create_system_tab(self):
        ...
        tools = [
            ...
            (
                "💿 Disk Usage Analyzer\nComing Soon",
                "Analyze disk space usage and cleanup",
                self.open_disk_analyzer,
            ),
            (
                "⚡ Process Monitor",
    ...
    def open_checksum(self):
        ...
        try:
            ...
            utility_window = self._create_utility_window(
                ChecksumGUI, "Checksum Verification"
            )

            if utility_window:
                self.status_bar.showMessage(
                    "Checksum Verification opened successfully"
                )
    ...
    def open_duplicate_finder(self):
        ...
        try:
            ...
            # Use the new window manager
            utility_window = self._create_utility_window(
                DuplicateFinderApp, "Duplicate Finder"
            )

            if utility_window:
                self.status_bar.showMessage(
                    "Duplicate Finder opened successfully"
                )
    ...
    def open_size_analyzer(self):
        ...
        try:
            ...
            # Use the new window manager
            utility_window = self._create_utility_window(
                SizeAnalyzerGUI, "Size Analyzer"
            )

            if utility_window:
                self.status_bar.showMessage(
                    "Size Analyzer opened successfully"
                )
    ...
    def open_empty_folders(self):
        ...
        try:
            ...
            # Use the new window manager
            utility_window = self._create_utility_window(
                EmptyFoldersGUI, "Empty Folders Finder"
            )

            if utility_window:
                self.status_bar.showMessage(
                    "Empty Folders Finder opened successfully"
                )
    ...
    def open_file_splitter(self):
        ...
        try:
            ...
            if (
                not hasattr(self, "file_splitter_window")
                or self.file_splitter_window is None
            ):
    ...
    def open_cmsd_logic(self):
        ...
        try:
            ...
            if not hasattr(self, "cmsd_window") or self.cmsd_window is None:
    ...
    def open_sync_backup(self):
        ...
        try:
            ...
            try:
                ...
                if (
                    not hasattr(self, "sync_backup_window")
                    or self.sync_backup_window is None
                ):
    ...
    def open_file_touch(self):
        ...
        try:
            ...
            if (
                not hasattr(self, "file_touch_window")
                or self.file_touch_window is None
            ):
    ...
    def open_organize_files(self):
        ...
        try:
            ...
            from src.tools.file_operations.organize.organize import (
                OrganizeWindow,
            )

            # Create and show the organize files window
            if (
                not hasattr(self, "organize_files_window")
                or self.organize_files_window is None
            ):
    ...
    def open_batch_rename(self):
        ...
        try:
            ...
            if (
                not hasattr(self, "batch_rename_window")
                or self.batch_rename_window is None
            ):
    ...
    def open_image_metadata(self):
        ...
        try:
            ...
            from enhanced_image_metadata_editor_with_menu import (
                EnhancedImageMetadataEditorGUI,
            )

            # Create and show the image metadata editor
            if (
                not hasattr(self, "image_metadata_window")
                or self.image_metadata_window is None
            ):
            ...
            self.status_bar.showMessage(
                "Image Metadata Editor opened successfully"
            )
            ...
            self.logger.error(
                f"ImportError opening Image Metadata Editor: {e}"
            )
        except Exception as e:
            self.status_bar.showMessage(
                f"Error opening Image Metadata Editor: {e}"
            )
    ...
    def open_office_metadata(self):
        ...
        try:
            ...
            from enhanced_office_metadata_editor_with_menu import (
                EnhancedOfficeMetadataEditorGUI,
            )

            # Create and show the office metadata editor
            if (
                not hasattr(self, "office_metadata_window")
                or self.office_metadata_window is None
            ):
            ...
            self.status_bar.showMessage(
                "Office Metadata Editor opened successfully"
            )
            ...
            self.logger.error(
                f"ImportError opening Office Metadata Editor: {e}"
            )
        except Exception as e:
            self.status_bar.showMessage(
                f"Error opening Office Metadata Editor: {e}"
            )
    ...
    def open_exif_viewer(self):
        ...
        try:
            ...
            self.logger.info(
                "EXIF Data Viewer (Image Metadata Editor) opened successfully"
            )
        except ImportError as e:
    ...
    def open_connectivity_test(self):
        ...
        self.status_bar.showMessage(
            "Connectivity Test - Feature coming soon..."
        )
    ...
    def open_bookmark_manager(self):
        ...
        self.status_bar.showMessage(
            "Bookmark Manager - Feature coming soon..."
        )
    ...
    def open_network_security(self):
        ...
        self.status_bar.showMessage(
            "Network Security - Feature coming soon..."
        )
    ...
    def open_file_encryption(self):
        ...
        try:
            ...
            # Use the new window manager
            utility_window = self._create_utility_window(
                EnAndDecryptGUI, "File Encryption"
            )

            if utility_window:
                self.status_bar.showMessage(
                    "File Encryption tool opened successfully"
                )
    ...
    def open_secure_delete(self):
        ...
        try:
            ...
            from enhanced_secure_delete_with_menu import (
                EnhancedSecureDeleteGUI,
            )

            # Create and show the secure delete window
            if (
                not hasattr(self, "secure_delete_window")
                or self.secure_delete_window is None
            ):
            ...
            self.status_bar.showMessage(
                "Secure Delete tool opened successfully"
            )
    ...
    def open_password_generator(self):
        ...
        try:
            ...
            self.status_bar.showMessage(
                f"Error opening Password Generator: {e}"
            )
    ...
    def open_security_monitor(self):
        ...
        self.status_bar.showMessage(
            "Security Monitor - Feature coming soon..."
        )
    ...
    def open_security_settings(self):
        ...
        try:
            ...
            from enhanced_security_preferences_with_menu import (
                EnhancedSecurityPreferencesGUI,
            )

            # Create and show the security settings window
            if (
                not hasattr(self, "security_settings_window")
                or self.security_settings_window is None
            ):
                self.security_settings_window = (
                    EnhancedSecurityPreferencesGUI()
                )
            ...
            self.status_bar.showMessage(
                "Security Settings opened successfully"
            )
            ...
            self.status_bar.showMessage(
                f"Error opening Security Settings: {e}"
            )
        ...
        try:
            ...
            if issubclass(utility_class, QMainWindow):
                ...
                if utility_widget:
                    ...
                    layout.addWidget(
                        QLabel(f"{title} - Not properly configured")
                    )
            ...
            self.logger.error(
                f"Error creating utility window for {title}: {e}"
            )
        ...
        if hasattr(self, window_attr_name):
            ...
            if old_window:
                try:
                    ...
                    self.logger.error(
                        f"Error closing old {window_attr_name}: {e}"
                    )
                ...
                for window_name, window in self._utility_windows.items():
                    try:
                        if window and not window.isHidden():
                            ...
                            window.deleteLater()
                            self.logger.info(
                                f"Closed utility window: {window_name}"
                            )
                    except Exception as e:
    ...
    def _close_window_attributes(self):
        ...
        window_attributes = [
            "checksum_window",
            "duplicate_finder_window",
            "size_analyzer_window",
            "empty_folders_window",
            "file_catalog_window",
            "file_splitter_window",
            "cmsd_window",
            "sync_backup_window",
            "file_touch_window",
            "organize_files_window",
            "batch_rename_window",
            "image_metadata_window",
            "office_metadata_window",
            "encryption_window",
            "secure_delete_window",
