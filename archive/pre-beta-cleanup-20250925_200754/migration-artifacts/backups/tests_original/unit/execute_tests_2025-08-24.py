...
def main():
    ...
    html_output = os.path.join(current_dir, f"result_encrypt_report_{timestamp}.html")
    json_output = os.path.join(current_dir, f"result_encrypt_results_{timestamp}.json")
