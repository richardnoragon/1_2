...
def setup_environment():
    ...
    metrics_path = project_root / "src" / "utilities" / "network" / "network_connectivity_complex" / "core"
...
def run_tests():
    ...
    test_file = project_root / "tests" / "unit" / "test_metrics_service_2025-08-30.py"
...
def generate_execution_summary(project_root, exit_code):
    ...
    summary_file = project_root / "tests" / "unit" / "result_metrics_service_execution_summary_2025-08-30.json"
