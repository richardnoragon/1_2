...
JSON_REPORT = RESULTS_DIR / f"result_enhanced_editor_results_{DATE_SUFFIX}.json"
COVERAGE_HTML = RESULTS_DIR / f"result_enhanced_editor_coverage_{DATE_SUFFIX}"
COVERAGE_JSON = RESULTS_DIR / f"result_enhanced_editor_coverage_{DATE_SUFFIX}.json"
EXECUTION_LOG = RESULTS_DIR / f"result_enhanced_editor_execution_{DATE_SUFFIX}.log"
...
def run_tests():
    ...
    try:
        ...
        with open(EXECUTION_LOG, 'w') as log_file:
            log_file.write(f"Test execution started: {summary['execution_info']['timestamp']}\n")
        ...
        if JSON_REPORT.exists():
            try:
                with open(JSON_REPORT, 'r') as f:
                    ...
                    print(f"Duration: {summary['test_results']['duration']:.2f} seconds")
        ...
        if COVERAGE_JSON.exists():
            try:
                with open(COVERAGE_JSON, 'r') as f:
                    ...
                    print(f"Coverage: {summary['coverage_results']['line_coverage']:.1f}% "
        ...
        summary_file = RESULTS_DIR / f"result_enhanced_editor_summary_{DATE_SUFFIX}.json"
