...
class TestSuiteRunner:
    ...
    def run_comprehensive_tests(self) -> Dict[str, Any]:
        ...
        for module_name, module_path in test_modules:
            ...
            if result['status'] == 'passed':
                ...
                self.results['errors'].append(f"{module_name}: {result.get('error', 'Unknown error')}")
            else:
    ...
    def _run_test_module(self, module_name: str, module_path: str) -> Dict[str, Any]:
    ...
    def _validate_core_functionality(self) -> bool:
        ...
        try:
            ...
            self.results['errors'].append(f"Core functionality validation failed: {e}")
            return False
    ...
    def _validate_hub_integration(self) -> bool:
        ...
        try:
            ...
            self.results['errors'].append(f"Hub integration validation failed: {e}")
            return False
