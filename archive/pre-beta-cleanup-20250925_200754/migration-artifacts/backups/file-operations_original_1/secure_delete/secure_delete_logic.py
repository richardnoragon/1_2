...
class SecureDeleteLogic:
    ...
    def delete_file(self, filepath: str, passes: int = DEFAULT_PASSES, 
        ...
        self.logger.info(f"Starting secure deletion of {filepath} "
                        f"with {passes} passes")
        ...
        try:
            ...
            for pass_num in range(self._total_passes):
                ...
                if progress_callback:
                    progress = int((self._current_pass / self._total_passes) * 100)
                    progress_callback(progress)
                
                self.logger.info(f"Starting pass {self._current_pass}/"
    ...
    def _perform_final_deletion(self, filepath: str) -> bool:
        ...
        try:
            ...
            if self._is_running:
                ...
                success_msg = f"File securely deleted: " \
    ...
    def delete_files(self, filepaths: list, passes: int = DEFAULT_PASSES,
                    progress_callback: Optional[Callable[[int], None]] = None,
                    cancel_check: Optional[Callable[[], bool]] = None) -> bool:
        """
    ...
    def delete_directory(self, directory_path: str, passes: int = DEFAULT_PASSES,
                        progress_callback: Optional[Callable[[int], None]] = None,
                        cancel_check: Optional[Callable[[], bool]] = None) -> bool:
        """
        ...
        try:
            ...
            success = self.delete_files(all_files, passes, progress_callback,
                                      cancel_check)
