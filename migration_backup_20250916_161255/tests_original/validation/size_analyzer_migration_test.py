...
def test_directory_analysis():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert 'total_size' in analysis, "Analysis should include total_size"
            assert 'file_count' in analysis, "Analysis should include file_count"
            assert 'directory_count' in analysis, "Analysis should include directory_count"
            assert 'files' in analysis, "Analysis should include files list"
            assert 'file_types' in analysis, "Analysis should include file_types"
...
def test_gui_creation():
    ...
    try:
        ...
        assert hasattr(gui, 'selected_directory'), "GUI should have selected_directory attribute"
