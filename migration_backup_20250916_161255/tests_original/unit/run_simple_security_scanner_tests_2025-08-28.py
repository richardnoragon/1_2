...
class SimpleSecurityScannerTestRunner:
    ...
    def run_tests(self):
        ...
        test_file = self.test_dir / "test_simple_security_scanner_2025-08-28.py"
        config_file = self.test_dir / "pytest_simple_security_scanner_2025-08-28.ini"
    ...
    def parse_coverage_results(self):
        ...
        coverage_file = self.test_dir / "result_simple_security_scanner_coverage_2025-08-28.json"
...
"""
        ...
        summary_file = self.test_dir / "result_simple_security_scanner_summary_2025-08-28.txt"
        with open(summary_file, 'w', encoding='utf-8') as f:
            f.write(summary)
        
        # Save JSON results
        json_file = self.test_dir / "result_simple_security_scanner_summary_2025-08-28.json"
    ...
    def run_complete_test_suite(self):
        ...
        if success:
            ...
            print(f"  - HTML Report: result_simple_security_scanner_report_2025-08-28.html")
            print(f"  - Coverage HTML: result_simple_security_scanner_coverage_2025-08-28/")
            print(f"  - Coverage JSON: result_simple_security_scanner_coverage_2025-08-28.json")
            print(f"  - JUnit XML: result_simple_security_scanner_junit_2025-08-28.xml")
            print(f"  - Summary: result_simple_security_scanner_summary_2025-08-28.txt")
        else:
