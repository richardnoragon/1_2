...
def mock_data_anonymizer_imports():
    ...
    with patch('src.utilities.privacy.data_anonymizer.PrivacyCleanerGUI') as mock_privacy:
        with patch('src.utilities.privacy.data_anonymizer.SimplePrivacyHub') as mock_simple:
            yield {
