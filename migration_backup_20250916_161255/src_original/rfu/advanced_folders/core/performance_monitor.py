...
class PerformanceMonitor:
    ...
    def get_metrics_summary(
        ...
        error_count = sum(1 for m in filtered_metrics if m.metadata.get('error', False))
        ...
        if filtered_metrics:
            ...
            for key in resource_keys:
                values = [
                    m.resource_usage.get(key, 0) for m in filtered_metrics
    ...
    def get_optimization_recommendations(self) -> List[OptimizationRecommendation]:
        ...
        if cache_summary.total_operations > 100:
            ...
            for metric in self.metrics_by_type[PerformanceMetricType.CACHE_OPERATION]:
    ...
    def _init_database(self) -> None:
        ...
        try:
            ...
            self.logger.error(f"Error initializing performance database: {str(e)}")
