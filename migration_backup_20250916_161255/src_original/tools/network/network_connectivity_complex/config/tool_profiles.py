        ...
        "port_scanner": {
            ...
            "udp_scan": {
                ...
                "settings": {
                    ...
                    "scan_policy": "normal",
                    "scan_type": "udp",
                    "common_ports": [53, 67, 68, 69, 123, 161, 162, 514, 1194, 1701]
                }
            },
            "web_services": {
            ...
            "database_scan": {
                ...
                "settings": {
                    ...
                    "scan_type": "tcp_connect",
                    "enable_banner_grabbing": True,
                    "common_ports": [1433, 1521, 3306, 5432, 6379, 27017, 9042, 7000, 7001]
                }
            },
            "remote_access": {
                ...
                "settings": {
                    ...
                    "enable_banner_grabbing": True,
                    "security_level": "strict",
                    "common_ports": [22, 23, 3389, 5900, 5901, 5902, 1723, 1701, 500, 4500]
                }
            }
        },
        "network_diagnostics": {
