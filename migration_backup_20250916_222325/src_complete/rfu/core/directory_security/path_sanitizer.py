...
class PathSanitizer:
    ...
    def _anonymize_for_logging(self, path: str) -> str:
        ...
        for component in components:
            ...
            if (len(component) == 2 and component.endswith(':')) or component in ['[USER]']:
                anonymized_components.append(component)
                continue
    ...
    def is_path_safe(self, directory_path: str) -> bool:
        ...
        try:
            ...
            if any(len(comp) > self.max_component_length for comp in components):
                return False
    ...
    def get_sanitization_report(self, original_path: str, 
                               sanitized_path: str) -> dict:
        """
