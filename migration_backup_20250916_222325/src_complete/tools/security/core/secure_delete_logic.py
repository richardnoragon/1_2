...
class SecureDeleteLogic(QObject):
    ...
    def _report_completion_to_hub(self, success_message: str):
        ...
        try:
            ...
            self.hub_connector.report_status_to_hub("completed", completion_details)
    ...
    def _request_resources(self) -> bool:
        ...
        try:
            ...
            if disk_granted:
                ...
                self.logger.info("Disk resources allocated for secure deletion")
                return True
            else:
    ...
    def stop(self) -> None:
        ...
        try:
            self.hub_connector.report_status_to_hub("stopped", {
    ...
    def shred_file(self, filepath: str, passes: int = DEFAULT_PASSES) -> None:
        ...
        self.logger.info(f"Starting secure deletion of {filepath} with {passes} passes")
        
        try:
            # Request resources from hub
            if not self._request_resources():
                self.error_occurred.emit("Failed to allocate required resources")
                return
            ...
            for pass_num in range(self._total_passes):
                ...
                pass_message = f"Pass {self._current_pass}/{self._total_passes}"
    ...
    def _perform_final_deletion(self, filepath: str):
        ...
        try:
            ...
            if self._is_running:
                ...
                success_msg = f"File securely deleted: {os.path.basename(filepath)}"
