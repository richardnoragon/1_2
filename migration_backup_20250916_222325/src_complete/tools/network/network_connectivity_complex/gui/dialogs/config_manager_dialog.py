...
from PyQt5.QtWidgets import (
    ...
    QTreeWidget, QTreeWidgetItem, QLabel, QLineEdit, QSpinBox,
    QDoubleSpinBox, QCheckBox, QComboBox, QPushButton, QTextEdit,
    QGroupBox, QFormLayout, QMessageBox, QFileDialog, QSplitter,
            ...
            if profile and not profile.is_active and not profile.is_default:
                ...
                if reply == QMessageBox.Yes:
                    ...
                    if success:
                        QMessageBox.information(
                            self, "Success", 
                            f"Deleted profile: {profile.name}"
                        )
                        self._load_profiles()
                    else:
                        QMessageBox.warning(
