...
class FilePermissionsGUI(QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def update_file_permissions(self, file):
        try:
            ...
            QMessageBox.warning(self, "Error", f"Could not read permissions for {file}: {str(e)}")

    def set_permissions(self):
        if self.model.rowCount() == 0:
            QMessageBox.information(self, "No Files", "Please add files to modify their permissions")
            return
