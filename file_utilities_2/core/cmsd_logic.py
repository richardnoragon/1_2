...
Provides the business logic for the Content Management System Directory
tool, keeping core operations separate from the GUI layer.
"""
...
class CMSDLogic:
    ...
    def copy_files(
        self, source_files: List[str], destination_dir: str
    ) -> OperationResult:
