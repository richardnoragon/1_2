...
try:
    from PyQt5.QtWidgets import (
        ...
        QGroupBox, QGridLayout, QPushButton, QCheckBox, QSpinBox,
...
class PerformanceWidget(QWidget):
    ...
    def apply_styling(self):
        ...
        try:
            ...
            for progress_bar in [self.cpu_usage_bar, self.memory_usage_bar, self.swap_usage_bar]:
    ...
    def update_system_display(self, data: Dict[str, Any]):
        ...
        try:
            ...
            if total_processes != 'N/A' and running_processes != 'N/A':
                self.processes_label.setText(f"{total_processes} ({running_processes} running)")
            else:
