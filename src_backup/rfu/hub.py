...
class MyGUI(BaseWindow):
    ...
    def open_network_connectivity(self) -> None:
        ...
        try:
            ...
            print(f"Error loading Network Connectivity Hub: {e}")
            # Fallback: show message about network connectivity tools
            from PyQt5.QtWidgets import QMessageBox
            QMessageBox.information(
                self,
                "Network Connectivity Hub",
                "Network Connectivity Hub is available!\n\n"
            ...
            print(f"Error opening Network Connectivity Hub: {e}")
