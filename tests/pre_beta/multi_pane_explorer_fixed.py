...
class MultiPaneFileExplorer(QMainWindow):
    ...
    def __init__(self):
        ...
        self.available_layouts = {
            ...
            2: ['horizontal', 'vertical'],  # Two panes: horizontal/vertical splits
    ...
    def setup_main_content_area(self, parent_layout):
        ...
        try:
            ...
            self._configure_splitter_sizes(main_splitter, left_panel, right_panel)
    ...
    def _configure_splitter_sizes(self, main_splitter, left_panel, right_panel):
    ...
    def _create_minimal_fallback_layout(self, parent_layout):
        ...
        # Implementation would go here for emergency fallback
        pass
