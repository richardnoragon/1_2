...
def test_tool_import(module_name, class_name):
    ...
    try:
        ...
        import_paths = [
            ...
            f"src.tools.file_operations.catalog.{module_name}",  # Catalog tools
            f"src.tools.file_operations.file_touch.{module_name}",  # File touch tools
            f"src.tools.file_operations.organize.{module_name}",  # Organize tools
            f"src.tools.file_operations.file_finder.{module_name}",  # File finder tools
