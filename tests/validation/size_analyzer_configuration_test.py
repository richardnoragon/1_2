...
class ConfigurationValidator:
    ...
    def log_test(
        self, test_name: str, status: str, message: str, details: str = None
    ):
        """Log a test result."""
        test_result = {
            "test": test_name,
    ...
    def test_directory_creation(self):
        ...
        try:
            ...
            for dir_name in directories_to_check:
                dir_path = self.size_analyzer_config.get_resource_path(
                    dir_name
                )
    ...
    def test_configuration_validation(self):
        ...
        try:
            validation_results = (
                self.size_analyzer_config.validate_configuration()
            )
