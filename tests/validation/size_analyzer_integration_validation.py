...
def test_new_imports():
    ...
    try:
        ...
        assert (
            SizeAnalyzer is PackageSizeAnalyzer
        ), "Package import mismatch for SizeAnalyzer"
        assert (
            SizeAnalyzerWorker is PackageWorker
        ), "Package import mismatch for SizeAnalyzerWorker"
        assert (
            SizeAnalyzerGUI is PackageGUI
        ), "Package import mismatch for SizeAnalyzerGUI"
