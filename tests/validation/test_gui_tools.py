...
def main():
    ...
    tools = {
        "File Management": [
            ...
            ("Rename Files", "file_utilities_2/gui/rename_gui.py"),
        ],
        "Organization": [
        ...
        "Analysis": [
            ("Analyze Size", "file_utilities_2/gui/size_analyzer_gui.py"),
        ...
        "System": [("File Permissions", "permissions_editor.py")],
        "Administration": [
    ...
    success_rate = (
        (len(results["success"]) / total_tests) * 100 if total_tests > 0 else 0
    )
