...
def run_log_manager_tests():
    ...
    try:
        ...
        cmd = [
            ...
            "--json-report",
            "--json-report-file="
            + str(test_dir / "result_log_manager_2025-08-28.json"),
            "--cov=src.log_manager",
            "--cov-report=html:"
            + str(test_dir / "result_log_manager_coverage_2025-08-28"),
            "--cov-report=json:"
            + str(test_dir / "result_log_manager_coverage_2025-08-28.json"),
    ...
    try:
        ...
        with open(summary_file, "w") as f:
            ...
            if coverage_dir.exists():
                ...
                f.write(
                    f"✗ {coverage_dir.name}/ (coverage HTML not generated)\n"
                )
