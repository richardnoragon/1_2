...
class MetricsServiceTestRunner:
    ...
    def __init__(self):
        ...
        self.result_files = {
            ...
            / f"result_metrics_service_{self.date_suffix}.html",
            "json_report": self.test_dir
            / f"result_metrics_service_{self.date_suffix}.json",
            "coverage_html": self.test_dir
            / f"result_metrics_service_coverage_{self.date_suffix}",
            "coverage_json": self.test_dir
            / f"result_metrics_service_coverage_{self.date_suffix}.json",
            "junit_xml": self.test_dir
            / f"result_metrics_service_{self.date_suffix}.xml",
            "summary_txt": self.test_dir
            / f"result_metrics_service_summary_{self.date_suffix}.txt",
            "execution_log": self.test_dir
            / f"result_metrics_service_execution_{self.date_suffix}.log",
        }
    ...
    def generate_summary_report(self):
        ...
        summary_json_path = (
            self.test_dir
            / f"result_metrics_service_summary_{self.date_suffix}.json"
        )
    ...
    def run_full_test_suite(self):
        ...
        print(
            "🚀 Starting comprehensive test execution for metrics_service.py"
        )
