...
class HubTestData:
    ...
    def get_sample_tool_methods(self) -> List[str]:
        ...
        return [
            'open_file_catalog', 'open_file_touch', 'open_file_splitter',
            'open_secure_delete', 'open_compression_tools', 'open_duplicate_finder',
            'open_image_metadata', 'open_office_metadata', 'open_pdf_tools',
            'open_network_transfer', 'open_network_scan', 'open_port_scanner',
            'open_network_monitor', 'open_bandwidth_test', 'open_wake_on_lan',
            'open_encrypt_decrypt', 'open_hash_calculator', 'open_password_generator',
            'open_security_preferences', 'open_key_manager', 'open_secure_notes',
            'open_clipboard_manager', 'open_system_monitor', 'open_registry_tools',
            'open_disk_tools', 'open_process_manager', 'open_service_manager'
        ]
...
class TestFixtures:
    ...
    def hub_with_mocks():
        ...
        with patch('rfu.hub.get_log_manager') as mock_log_mgr, \
             patch('rfu.hub.get_config_manager') as mock_config_mgr, \
