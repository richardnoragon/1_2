...
class TestFixtures:
    ...
    def create_mock_pdf_with_images():
        ...
        page2 = Mock()
        page2.get_images.return_value = [(3, "small_image_data")]
...
%%EOF"""
    ...
    def create_temp_image_file(
        temp_dir, filename="test_image.png", width=100, height=100
    ):
...
def temp_test_dirs():
    ...
    yield {"input": temp_input, "output": temp_output, "assets": temp_assets}
