...
class TestSecurityScanWorker:
    ...
    @patch('src.tools.security.security_scanner.security_scanner.platform')
    def test_scan_system_info_success(self, mock_platform, security_scan_worker):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.socket.gethostname', return_value="TestHost"):
    ...
    with patch('src.tools.security.security_scanner.security_scanner.socket.gethostname', return_value="LinuxHost"):
            result = security_scan_worker.scan_system_info()
    ...
    @patch('src.tools.security.security_scanner.security_scanner.socket')
    ...
    @patch('src.tools.security.security_scanner.security_scanner.platform')
    @patch('src.tools.security.security_scanner.security_scanner.os')
    ...
    @patch('src.tools.security.security_scanner.security_scanner.platform')
    @patch('src.tools.security.security_scanner.security_scanner.subprocess')
...
class TestSimpleSecurityScannerGUI:
    ...
    def test_start_scan_with_all_options(self, mock_pyqt5, security_scanner_gui):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.SecurityScanWorker') as mock_worker_class:
...
class TestSimpleSecurityScannerEdgeCases:
    ...
    def test_empty_subprocess_output(self, mock_pyqt5, worker_single_scan):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.platform.system', return_value="Windows"):
            with patch('src.tools.security.security_scanner.security_scanner.subprocess.check_output', return_value=""):
    ...
    def test_network_timeout_simulation(self, mock_pyqt5, worker_single_scan):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.socket') as mock_socket:
    ...
    def test_file_permission_with_special_characters(self, mock_pyqt5, worker_single_scan):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.platform.system', return_value="Windows"):
            with patch('src.tools.security.security_scanner.security_scanner.os.path.expanduser') as mock_expanduser:
                with patch('src.tools.security.security_scanner.security_scanner.os.path.exists', return_value=True):
                    with patch('src.tools.security.security_scanner.security_scanner.os.access', return_value=True):
...
class TestSimpleSecurityScannerErrorHandling:
            ...
            with patch('builtins.print') as mock_print:
                with patch('sys.exit') as mock_exit:
                    try:
                        ...
                        if 'src.tools.security.security_scanner.security_scanner' in sys.modules:
                            del sys.modules['src.tools.security.security_scanner.security_scanner']
                        
                        # This should trigger the import error handling
                        import src.tools.security.security_scanner.security_scanner
                    except SystemExit:
                        # Expected behavior when PyQt5 is not available
                        pass
    
    @patch('src.tools.security.security_scanner.security_scanner.QApplication')
    @patch('src.tools.security.security_scanner.security_scanner.SimpleSecurityScannerGUI')
    def test_main_function_execution(self, mock_gui_class, mock_qapp_class):
        ...
        with patch('sys.argv', ['simple_security_scanner.py']):
            with patch('sys.exit') as mock_exit:
                from src.tools.security.security_scanner.security_scanner import main
                main()
...
class TestSimpleSecurityScannerPerformance:
    ...
    def test_large_process_list_performance(self, worker_for_performance):
        ...
        with patch('src.tools.security.security_scanner.security_scanner.platform.system', return_value="Windows"):
            with patch('src.tools.security.security_scanner.security_scanner.subprocess.check_output', return_value=large_output):
