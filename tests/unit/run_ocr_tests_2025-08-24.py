...
def main():
    ...
    try:
        ...
        summary_file = project_root / "tests" / "unit" / f"result_ocr_execution_summary_2025-08-24_{execution_timestamp}.txt"
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write("\nReports Generated:\n")
            f.write(f"- HTML Report: result_ocr_2025-08-24_{execution_timestamp}.html\n")
            f.write(f"- JSON Report: result_ocr_2025-08-24_{execution_timestamp}.json\n")
            f.write(f"- Coverage HTML: htmlcov_ocr_2025-08-24_{execution_timestamp}/\n")
            f.write(f"- Coverage JSON: coverage_ocr_2025-08-24_{execution_timestamp}.json\n")
