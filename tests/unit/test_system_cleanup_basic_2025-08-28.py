...
def test_imports():
    ...
    try:
        from tools.system import system_cleanup
...
def test_pyqt5_availability_check():
    ...
    try:
        from tools.system.system_cleanup import PYQT5_AVAILABLE
...
def test_main_function_exists():
    ...
    try:
        from tools.system.system_cleanup import main
...
def test_module_constants():
    ...
    try:
        from tools.system.system_cleanup import (CLEANUP_TOOLS_AVAILABLE,
