...
class MinerTestRunner:
    ...
    def generate_summary(self, test_success):
        ...
        with open(self.summary_file, "w") as f:
            ...
            f.write(
                f"Test Success: {'PASSED' if test_success else 'FAILED'}\\n\\n"
            )
            ...
            if "test_results" in summary:
                ...
                f.write(
                    f"Test Duration: {results['duration']:.2f} seconds\\n\\n"
                )
            ...
            if "coverage" in summary:
                ...
                f.write("-" * 20 + "\\n")
                f.write(
                    f"Total Coverage: {coverage['total_coverage']:.1f}%\\n"
                )
            ...
            f.write("-" * 20 + "\\n")
            for file_type, filename in summary["test_execution_summary"][
                "output_files"
            ].items():
                f.write(
