    ...
    def test_defaults_structure_comprehensive(self, mock_config_manager):
        ...
        try:
            ...
            for section in expected_sections:
                ...
                assert isinstance(defaults[section], dict), f"Section {section} is not a dict"
...
class TestSizeAnalyzerConfigCore:
    ...
    def test_merge_with_defaults_comprehensive(self, size_analyzer_config):
        ...
        try:
            ...
            assert merged['ui']['progress_visualization']['custom_viz_option'] == 'custom_value'
...
class TestSizeAnalyzerConfigSettings:
    ...
    def test_get_setting_all_scenarios(self, size_analyzer_config):
        ...
        try:
            ...
            assert size_analyzer_config.get_setting('general', 'module_path') == 'test_path'
            assert size_analyzer_config.get_setting('general', 'enable_logging') is True
            assert size_analyzer_config.get_setting('general', 'max_recent_directories') == 15
            ...
            result = size_analyzer_config.get_setting('missing_section', 'missing_key', 'fallback')
    ...
    def test_set_setting_comprehensive(self, size_analyzer_config):
        ...
        try:
            ...
            assert result is True
            assert size_analyzer_config.config_manager.config['size_analyzer']['general']['test_key'] == 42
            ...
            result = size_analyzer_config.set_setting('general', 'complex_data', complex_data)
            assert result is True
            assert size_analyzer_config.config_manager.config['size_analyzer']['general']['complex_data'] == complex_data
    ...
    def test_get_resource_path_scenarios(self, size_analyzer_config, temp_directory):
        ...
        try:
            ...
            size_analyzer_config.config_manager.config = {
                'size_analyzer': {
                    'resources': {
                        'absolute_resource': absolute_path
                    }
                }
            }
            ...
            size_analyzer_config.config_manager.config['size_analyzer']['resources']['relative_resource'] = relative_path
            ...
            # Test empty path
            size_analyzer_config.config_manager.config['size_analyzer']['resources']['empty_resource'] = ''
...
class TestSizeAnalyzerConfigValidation:
    ...
    def test_validate_configuration_comprehensive(self, size_analyzer_config, temp_directory):
        ...
        try:
            ...
            assert 'missing_file.txt' in warning_messages or 'Resource not found' in warning_messages
...
class TestSizeAnalyzerConfigImportExport:
    ...
    def test_export_import_configuration_roundtrip(self, size_analyzer_config, temp_directory):
        ...
        try:
            ...
            assert size_analyzer_config.get_setting('general', 'module_path') == 'custom.module.path'
            assert size_analyzer_config.get_setting('analysis', 'default_top_files_count') == 50
            assert size_analyzer_config.get_setting('ui', 'window_geometry')['width'] == 1200
            assert size_analyzer_config.get_setting('custom_section', 'custom_key') == 'custom_value'
...
if __name__ == '__main__':
    ...
    report_file = os.path.join(results_dir, f'result_size_analyzer_config_{timestamp}.json')
    ...
    print(f"Success rate: {test_tracker.tests_passed / test_tracker.tests_run * 100:.1f}%" if test_tracker.tests_run > 0 else "No tests run")