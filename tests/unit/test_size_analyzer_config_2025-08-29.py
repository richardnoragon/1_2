...
class TestSizeAnalyzerConfig:
    ...
    def size_analyzer_config(self, mock_config_manager, mock_logger):
        ...
        with patch(
            "src.tools.analysis.size_analyzer.size_analyzer_config.get_config_manager",
            return_value=lambda: mock_config_manager,
        ):
            with patch(
                "src.tools.analysis.size_analyzer.size_analyzer_config.get_log_manager"
            ) as mock_log_manager:
    ...
    def test_ensure_configuration_exists_exception_handling(self, size_analyzer_config):
        ...
        with patch.object(
            size_analyzer_config.config_manager,
            "save_config",
    ...
    def test_merge_with_defaults_nested_dicts(self, size_analyzer_config):
        ...
        existing_config = {
            "general": {"module_path": "custom_path", "new_key": "new_value"},
            "ui": {"window_geometry": {"width": 1024, "custom_property": True}},
        }
    ...
    def test_get_setting_existing_value(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"general": {"module_path": "test_path"}}
        }
    ...
    def test_set_setting_new_subsection(self, size_analyzer_config):
        ...
        assert (
            size_analyzer_config.config_manager.config["size_analyzer"]["new_section"][
                "new_key"
            ]
            == "new_value"
        )
    ...
    def test_add_recent_directory_exception(self, size_analyzer_config):
        ...
        with patch.object(
            size_analyzer_config, "get_setting", side_effect=Exception("Get error")
        ):
    ...
    def test_get_recent_directories(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"general": {"recent_directories": test_dirs}}
        }
    ...
    def test_save_window_geometry_full_parameters(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"ui": {"window_geometry": {"remember_size": True}}}
        }
    ...
    def test_save_window_geometry_exception(self, size_analyzer_config):
        ...
        with patch.object(
            size_analyzer_config, "set_setting", side_effect=Exception("Set error")
        ):
            result = size_analyzer_config.save_window_geometry(800, 600)
            assert result is False
    ...
    def test_get_window_geometry(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"ui": {"window_geometry": custom_geometry}}
        }
    ...
    def test_get_resource_path_absolute_path(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"resources": {"test_resource": absolute_path}}
        }
    ...
    def test_get_resource_path_relative_path(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"resources": {"test_resource": relative_path}}
        }
    ...
    def test_get_resource_path_empty_path(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {"resources": {"test_resource": ""}}
        }
    ...
    def test_validate_configuration_success(self, size_analyzer_config, temp_directory):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {
                ...
                "analysis": {"default_top_files_count": 20},
            }
        }
    ...
    def test_validate_configuration_missing_resources(self, size_analyzer_config):
        ...
        size_analyzer_config.config_manager.config = {
            "size_analyzer": {
                "resources": {"missing_file": "/nonexistent/path/file.txt"},
                "performance": {
                    "max_memory_usage_mb": 32,  # Low memory
                    "operation_timeout_seconds": 10,  # Low timeout
                },
                "analysis": {"default_top_files_count": 200},  # High count
            }
        }
        ...
        assert any(
            "Memory limit is very low" in warning for warning in issues["warnings"]
        )
        assert any(
            "Operation timeout is very low" in warning for warning in issues["warnings"]
        )
    ...
    def test_validate_configuration_exception(self, size_analyzer_config):
        ...
        with patch.object(
            size_analyzer_config, "get_all_settings", side_effect=Exception("Get error")
        ):
            issues = size_analyzer_config.validate_configuration()

            assert len(issues["errors"]) >= 1
            assert any(
                "Configuration validation error" in error for error in issues["errors"]
            )
    ...
    def test_import_configuration_invalid_structure(
        self, size_analyzer_config, temp_directory
    ):
...
class TestEdgeCases:
    ...
    def test_none_values_handling(self, mock_config_manager):
        ...
        mock_config_manager.config = {
            "size_analyzer": {
                "general": {"module_path": None, "last_opened_directory": None}
            }
        }
    ...
    def test_configuration_validation_workflow(self, temp_directory):
        ...
        mock_cm.config = {
            "size_analyzer": {
                ...
                "analysis": {"default_top_files_count": 30},
            }
        }
        mock_cm.save_config = Mock()
