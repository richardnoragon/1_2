...
def setup_network_module_dependencies() -> Dict[str, Any]:
    ...
    platform_network_detector.get_available_interfaces = Mock(return_value=[])
...
def setup_config_manager_mocks() -> Dict[str, Any]:
    ...
    return {"robust_config": robust_config}
...
def setup_all_dependency_mocks() -> Dict[str, Any]:
    ...
    all_deps = {**network_deps, **browser_deps, **config_deps, **viz_deps}
