...
class TestRenameWindow:
    ...
    def test_load_available_files_success(self, rename_window, temp_directory, sample_files):
        """Test successful loading of available files."""
        rename_window.current_directory = temp_directory
        
        with patch('os.listdir', return_value=sample_files), \
            ...
            assert rename_window.available_files_list.addItem.call_count == len(sample_files)
    ...
    def test_add_selected_files(self, rename_window):
        ...
        rename_window.available_files_list.selectedItems.return_value = [mock_item1, mock_item2]
        rename_window.selected_files = []
    ...
    def test_preview_changes_success(self, rename_window):
        ...
        with patch.object(rename_window, 'get_new_filename', side_effect=["new_file1.txt", "new_file2.txt"]):
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_load_available_files_with_mixed_content(self, rename_window, temp_directory):
        ...
        with patch('os.listdir', return_value=files_and_dirs), \
...
class TestPerformanceAndMemory:
    ...
    def test_large_file_list_handling(self, rename_window, temp_directory):
        ...
        with patch('os.listdir', return_value=large_file_list), \
             patch('os.path.isfile', return_value=True):
