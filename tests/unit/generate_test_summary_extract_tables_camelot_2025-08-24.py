...
def generate_execution_summary():
    ...
    json_report_path = Path(
        "result_extract_tables_camelot_simple_2025-08-24.json"
    )
    ...
    output_files = [
        (
            "HTML Test Report",
            "result_extract_tables_camelot_simple_2025-08-24.html",
        ),
        (
            "JSON Test Report",
            "result_extract_tables_camelot_simple_2025-08-24.json",
...
def main():
    ...
    print(
        f"📊 Results: {results['passed']}/{results['total_tests']} tests passed"
    )
