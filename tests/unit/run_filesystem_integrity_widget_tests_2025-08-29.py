...
def run_tests():
    ...
    # Output file paths
    html_report = (
        current_dir / "result_filesystem_integrity_widget_2025-08-29.html"
    )
    json_report = (
        current_dir / "result_filesystem_integrity_widget_2025-08-29.json"
    )
    coverage_html = (
        current_dir / "result_filesystem_integrity_widget_coverage_2025-08-29"
    )
    coverage_xml = (
        current_dir
        / "result_filesystem_integrity_widget_coverage_2025-08-29.xml"
    )
    summary_report = (
        current_dir
        / "result_filesystem_integrity_widget_summary_2025-08-29.md"
    )
