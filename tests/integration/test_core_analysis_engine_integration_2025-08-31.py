...
class TestCoreAnalysisEngineIntegration:
    ...
    def test_analyzer_config_logging_integration(self, qapp, comprehensive_test_environment):
    ...
    def test_concurrent_analysis_integration(self, qapp, comprehensive_test_environment):
    ...
    def test_performance_monitoring_integration(self, qapp, comprehensive_test_environment):
    ...
    def test_configuration_impact_on_analysis(self, qapp, comprehensive_test_environment):
        ...
        for config_data in configurations:
            with patch.object(SizeAnalyzerConfig, 'get_all_settings', return_value=config_data):
                config = SizeAnalyzerConfig()
                analyzer = SizeAnalyzer()
