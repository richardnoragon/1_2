...
def test_network_transfer_import():
    ...
    try:
        from src.tools.network.transfer.network_transfer import NetworkTransferGUI, TransferProtocol
...
def test_transfer_protocol():
    ...
    try:
        from src.tools.network.transfer.network_transfer import TransferProtocol
...
def test_gui_creation():
    ...
    try:
        ...
        from src.tools.network.transfer.network_transfer import NetworkTransferGUI
