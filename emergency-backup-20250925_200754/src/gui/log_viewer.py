...
class LogViewerWindow(BaseWindow):
    ...
    def refresh_logs(self):
        ...
        try:
            ...
            show_error_dialog(
                f"Failed to refresh log files: {str(e)}", parent=self
            )
    ...
    def load_log_content(self):
        ...
        try:
            ...
            show_error_dialog(
                f"Failed to load log content: {str(e)}", parent=self
            )
    ...
    def apply_filters(self):
        ...
        try:
            ...
            show_error_dialog(
                f"Failed to apply filters: {str(e)}", parent=self
            )
    ...
    def export_log(self):
        ...
        try:
            ...
            if not current_file:
                show_error_dialog(
                    "No log file selected", title="Warning", parent=self
                )
                return
            ...
            show_error_dialog(f"Failed to export log: {str(e)}", parent=self)
    ...
    def clear_log(self):
        ...
        try:
            ...
            show_error_dialog(f"Failed to clear log: {str(e)}", parent=self)
...
def main():
    ...
    try:
        ...
        if logger:
            ...
            print(error_msg)
        show_error_dialog(error_msg, title="Fatal Error")
        sys.exit(1)
