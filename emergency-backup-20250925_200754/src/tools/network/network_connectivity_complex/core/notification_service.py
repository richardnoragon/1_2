...
class NotificationRule:
    ...
    def should_trigger(self, event_data: Dict[str, Any]) -> bool:
        ...
        if (
            self.last_triggered
            and (datetime.now() - self.last_triggered).total_seconds()
    ...
    def create_notification(self, event_data: Dict[str, Any]) -> Notification:
        ...
        notification = Notification(
            ...
            channels=[
                ...
                for ch in template.get("channels", ["gui"])
            ],
...
class NotificationHandler:
    ...
    def can_handle(self, notification: Notification) -> bool:
        ...
        return self.enabled and any(
            channel in self.channels for channel in notification.channels
        )
...
class LogNotificationHandler(NotificationHandler):
    ...
    def handle(self, notification: Notification):
        ...
        logger = get_network_logging_manager().get_tool_logger(
            notification.source
        )
...
class SoundNotificationHandler(NotificationHandler):
    ...
    def handle(self, notification: Notification):
        ...
        try:
            ...
            sound_file = self._sound_files.get(
                notification.type, "default.wav"
            )
...
class NotificationService:
    ...
    def _initialize(self):
        ...
        try:
            ...
            self.logger.error(
                f"Failed to initialize notification service: {e}"
            )
            raise
    ...
    def _create_default_rules(self):
        ...
        self.add_rule(
            ...
            condition=lambda data: (
                ...
                and data.get("threshold_exceeded", False)
            ),
            notification_template={
                "type": "performance",
                "priority": 2,
    ...
    def _processing_loop(self):
        ...
        while not self._stop_event.is_set():
            try:
                ...
                self.logger.error(
                    f"Error in notification processing loop: {e}"
                )
    ...
    def _cleanup_expired_notifications(self):
        ...
        with self._lock:
            ...
            if expired_ids:
                self.logger.debug(
                    f"Cleaned up {len(expired_ids)} expired notifications"
                )
    ...
    def send_notification(
        ...
        title: str,
        message: str,
        source: str = "NetworkConnectivity",
    ...
    def acknowledge_notification(
        self, notification_id: str, acknowledged_by: str = None
    ) -> bool:
    ...
    def get_notifications(
        ...
        with self._lock:
            ...
            for notification in self._notifications.values():
                ...
                if (
                    priority_filter
                    and notification.priority != priority_filter
                ):
                    continue
    ...
    def clear_notifications(self, acknowledged_only: bool = True):
        ...
        with self._lock:
            if acknowledged_only:
                ...
                self.logger.info(
                    f"Cleared {len(to_remove)} acknowledged notifications"
                )
            else:
...
def notify_info(
    title: str, message: str, source: str = "NetworkConnectivity", **kwargs
):
