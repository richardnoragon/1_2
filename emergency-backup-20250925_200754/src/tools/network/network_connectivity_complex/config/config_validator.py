...
class PortValidationRule(ValidationRule):
    ...
    def __init__(
        ...
        super().__init__(
            "port_number", "Value must be a valid port number", severity
        )
...
class ConfigurationValidator:
    ...
    def _setup_default_rules(self):
        ...
        self.add_rule(
            ...
            [TypeValidationRule(int), RangeValidationRule(1000, 60000)],
        )

        self.add_rule(
            "general.max_concurrent_operations",
            [TypeValidationRule(int), RangeValidationRule(1, 100)],
        )
        ...
        self.add_rule(
            "general.results_retention_days",
            [TypeValidationRule(int), RangeValidationRule(1, 365)],
        )

        # Bandwidth monitor settings
        self.add_rule(
            "bandwidth_monitor.monitoring_interval",
            [TypeValidationRule(int), RangeValidationRule(100, 10000)],
        )
        ...
        self.add_rule(
            "bandwidth_monitor.data_retention_hours",
            [TypeValidationRule(int), RangeValidationRule(1, 8760)],  # 1 year
        )

        # WiFi analyzer settings
        self.add_rule(
            "wifi_analyzer.scan_interval",
            [
        ...
        self.add_rule(
            "wifi_analyzer.weak_signal_threshold",
            [
                TypeValidationRule(int),
        ...
        self.add_rule(
            "wifi_analyzer.security_alert_level",
            [
                TypeValidationRule(str),
        ...
        self.add_rule(
            ...
            [TypeValidationRule(int), RangeValidationRule(100, 30000)],
        )

        self.add_rule(
            "port_scanner.max_threads",
            [TypeValidationRule(int), RangeValidationRule(1, 1000)],
        )

        self.add_rule(
            "port_scanner.default_scan_type",
            [
                TypeValidationRule(str),
        ...
        self.add_rule(
            "lan_file_transfer.discovery_port",
            [
                TypeValidationRule(int),
        ...
        self.add_rule(
            "lan_file_transfer.transfer_port",
            [
                TypeValidationRule(int),
                PortValidationRule(allow_well_known=False),
            ],
        ...
        self.add_rule(
            "lan_file_transfer.max_file_size_mb",
            [
                TypeValidationRule(int),
        ...
        self.add_rule(
            "security.max_scan_rate",
            [TypeValidationRule(int), RangeValidationRule(1, 10000)],
        )

        # Performance settings
        self.add_rule(
            "performance.max_memory_usage_mb",
            [TypeValidationRule(int), RangeValidationRule(64, 4096)],
        )

        self.add_rule(
            "performance.max_cpu_usage_percent",
            [TypeValidationRule((int, float)), RangeValidationRule(1, 100)],
        )

        # Custom validation rules
        self.add_rule("general.enable_logging", [TypeValidationRule(bool)])

        self.add_rule("general.auto_save_results", [TypeValidationRule(bool)])
    ...
    def _add_complex_rules(self):
        ...
        self.add_rule(
            "lan_file_transfer.blocked_file_types",
            [
                CustomValidationRule(
                    "file_extensions",
    ...
    def _validate_section(
        self, section: Dict[str, Any], section_path: str
    ) -> List[ValidationResult]:
    ...
    def _validate_port_conflicts(
        ...
        if (
            discovery_port
            and transfer_port
            and discovery_port == transfer_port
        ):
            results.append(
                ValidationResult(
    ...
    def get_validation_summary(
        ...
        for result in results:
            ...
            summary["most_common_issues"][issue_type] = (
                summary["most_common_issues"].get(issue_type, 0) + 1
            )
