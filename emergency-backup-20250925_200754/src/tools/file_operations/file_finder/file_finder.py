...
from src.gui.common.dialogs import show_error_dialog, get_existing_directory
    ...
    def search_file_content(self, file_path: str, search_text: str) -> bool:
        ...
        try:
            ...
            if file_path_obj.suffix.lower() == ".txt":
                ...
                return self.search_word_document(
                    str(file_path_obj), search_text
                )
            elif file_path_obj.suffix.lower() == ".pdf":
                return self.search_pdf_document(
                    str(file_path_obj), search_text
                )
            else:
                return False
            ...
            for filename in filenames:
                ...
                if extensions != ["*"]:
                    ...
                    if (
                        ...
                        and filetype not in filename.lower()
                    ):
                        continue
...
class FileFinder(QDialog):
    ...
    def __init__(self, config_manager=None):
        ...
        self.type_combo.addItems(
            ["All Files", "Text Files", "Images", "Documents"]
        )
