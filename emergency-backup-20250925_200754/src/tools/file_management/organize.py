...
class OrganizeWindow(StandardWindow):
    ...
    def _setup_menu_callbacks(self):
        ...
        if hasattr(self, "menu_manager"):
            ...
            self.menu_manager.register_callback(
                "new_organize", self.clear_organization
            )
            self.menu_manager.register_callback(
    ...
    def _update_file_list(self) -> None:
        ...
        try:
            ...
            show_error_dialog(
                self, "Error", f"Could not read directory: {str(e)}"
            )
    ...
    def _organize_files(self) -> None:
        ...
        try:
            ...
            show_error_dialog(
                self, "Error", f"Failed to organize files: {str(e)}"
            )
    ...
    def _undo_last_organization(self) -> None:
        ...
        try:
            ...
            show_error_dialog(
                self, "Error", f"Failed to undo organization: {str(e)}"
            )
