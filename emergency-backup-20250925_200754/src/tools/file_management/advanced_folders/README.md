...
def open_smart_search(self):
    ...
    try:
        from src.tools.file_management.advanced_folders.smart_search_gui import SmartSearchGUI
...
```bash
# Run all tests
python -m pytest src/tools/file_management/advanced_folders/tests/ -v

# Run specific test categories
python -m pytest src/tools/file_management/advanced_folders/tests/test_core_functionality.py -v

# Run with coverage
python -m pytest src/tools/file_management/advanced_folders/tests/ --cov=src.tools.file_management.advanced_folders

# Run performance benchmarks
python src/tools/file_management/advanced_folders/tests/test_core_functionality.py
```
