...
class ValidationException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = kwargs.get(
            "suggestion"
        ) or self._get_validation_suggestion(validation_rule)
    ...
    def _get_validation_suggestion(
        self, validation_rule: Optional[str]
    ) -> Optional[str]:
        ...
        return suggestions.get(
            validation_rule, "Please check the input value and try again."
        )
...
class RepositoryException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = kwargs.get(
            "suggestion"
        ) or self._get_repository_suggestion(operation)
    ...
    def _get_repository_suggestion(
        ...
        return suggestions.get(
            operation, "Check database connectivity and permissions."
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = (
            ...
            or "Check configuration file syntax and permissions."
        )
...
class SearchException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = (
            kwargs.get("suggestion")
            or "Simplify the search query or check folder accessibility."
        )
...
class FileSystemException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        context = kwargs.get("context", {})
        context.update({"file_path": file_path, "operation": operation})

        error_code = kwargs.get("error_code", "AF_FILESYSTEM_ERROR")
        suggestion = (
            kwargs.get("suggestion")
            or "Check file permissions and path accessibility."
        )
...
class PerformanceException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = (
            kwargs.get("suggestion")
            or "Consider reducing operation scope or increasing timeout limits."
        )
...
class MetadataException(AdvancedFoldersException):
    """
    Exception raised for metadata extraction and processing errors.

    Used for metadata extraction failures, unsupported formats, and processing issues.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        error_code = kwargs.get("error_code", "AF_METADATA_ERROR")
        suggestion = (
            kwargs.get("suggestion")
            or "Check file format and ensure it's supported for metadata extraction."
        )
...
class CacheException(AdvancedFoldersException):
    """
    Exception raised for cache operation errors.

    Used for cache corruption, storage issues, and cache management problems.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            cache_type: Type of cache (memory, disk, etc.)
            cache_key: Cache key that caused the error
            **kwargs: Additional arguments for base exception
        """
        context = kwargs.get("context", {})
        context.update({"cache_type": cache_type, "cache_key": cache_key})

        error_code = kwargs.get("error_code", "AF_CACHE_ERROR")
        suggestion = (
            kwargs.get("suggestion")
            or "Clear cache or check cache storage permissions."
        )
...
class PermissionException(AdvancedFoldersException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        suggestion = (
            kwargs.get("suggestion")
            or "Check file permissions and run with appropriate privileges."
        )
...
def validation_error(
    message: str, field_name: Optional[str] = None, **kwargs
) -> ValidationException:
...
def repository_error(
    message: str, operation: Optional[str] = None, **kwargs
) -> RepositoryException:
...
def config_error(
    message: str, section: Optional[str] = None, **kwargs
...
def search_error(
    message: str, query: Optional[str] = None, **kwargs
) -> SearchException:
...
def filesystem_error(
    message: str, path: Optional[str] = None, **kwargs
) -> FileSystemException:
...
def performance_error(
    message: str, timeout: Optional[float] = None, **kwargs
