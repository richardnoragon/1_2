...
class SecureDeleteConfig:
    ...
    def __init__(self, config_dir: Optional[str] = None):
        ...
        self.logger.info(
            f"SecureDeleteConfig initialized with config dir: {self.config_dir}"
        )
        ...
        try:
            if key == "default_passes":
                return (
                    ...
                    and 1 <= value <= self.settings.max_passes
                )
            elif key == "max_passes":
                ...
                "enable_hub_integration",
                "enable_progress_reporting",
                "enable_resource_management",
                "auto_cleanup",
                "confirm_deletion",
