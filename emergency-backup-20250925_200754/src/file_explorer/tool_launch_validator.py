...
class ToolLaunchValidator:
    ...
    def validate_tool_launch(
        self, tool_class: Type, tool_name: str, parent_widget: Any = None
    ) -> Dict[str, Any]:
        """
    ...
    def _filter_strategy_params(self, strategy: Dict, constructor_info: Dict):
        ...
        for param_name, param_value in strategy["params"].items():
            param_exists = any(p["name"] == param_name for p in parameters)
            if param_exists:
    ...
    def _configure_instance(
        self, tool_instance: Any, tool_name: str, parent_widget: Any = None
    ):
        ...
        try:
            ...
            if (
                parent_widget
                and hasattr(tool_instance, "setParent")
                and tool_instance.parent() != parent_widget
            ):
                try:
