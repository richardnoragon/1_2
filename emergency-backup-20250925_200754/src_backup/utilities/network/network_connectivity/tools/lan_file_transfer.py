...
class TransferManager:
    ...
    def send_file(self, job: TransferJob, target_device: NetworkDevice) -> bool:
...
class LANFileTransfer(NetworkToolBase):
    ...
    def _add_trusted_device_operation(self, **kwargs) -> NetworkOperationResult:
        """Add device to trusted list."""
    ...
    def validate_parameters(self, **kwargs) -> bool:
        ...
        valid_operations = [
            'start_service', 'stop_service', 'send_file',
            'discover_devices', 'get_status', 'add_trusted_device',
            'block_device'
        ]
