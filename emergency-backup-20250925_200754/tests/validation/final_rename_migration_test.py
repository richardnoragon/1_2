...
def test_configuration_updates():
    ...
    config_files = [
        (
            "tools/apply_standardized_styling.py",
            "file_utilities_2/gui/rename_gui.py",
        ),
...
def main():
    ...
    if passed == total:
        ...
        print(
            "✅ All rename functionality has been migrated to file_utilities_2/gui/"
        )
        ...
        print(
            "Please review and fix the failing tests before considering migration complete."
        )
        return 1
