...
class CoreAnalysisEngineTestRunner:
        ...
        self.test_suites = [
            {
                ...
                "file": str(
                    script_dir
                    / "unit"
                    / "test_size_analyzer_logging_comprehensive_2025-08-31.py"
                ),
                "type": "unit",
            ...
            },
            {
                ...
                "file": str(
                    script_dir
                    / "unit"
                    / "test_core_analysis_engine_comprehensive_2025-08-31.py"
                ),
                "type": "unit",
            ...
            },
            {
                ...
                "file": str(
                    script_dir
                    / "integration"
                    / "test_core_analysis_engine_integration_2025-08-31.py"
                ),
                "type": "integration",
            ...
            },
            {
                ...
                "file": str(
                    script_dir
                    / "performance"
                    / "test_core_analysis_engine_benchmarks_2025-08-31.py"
                ),
                "type": "performance",
            ...
            },
            {
                ...
                "file": str(
                    script_dir
                    / "e2e"
                    / "test_core_analysis_engine_e2e_2025-08-31.py"
                ),
                "type": "e2e",
    ...
    def run_all_tests(self) -> None:
        ...
        print("=" * 80)
        print(
            f"Starting comprehensive test run at {time.strftime('%Y-%m-%d %H:%M:%S')}"
        )
    ...
    def generate_final_report(self) -> None:
        ...
        print("-" * 30)
        performance_results = [
            r for r in self.results if "Performance" in r.test_suite
        ]
        if performance_results:
            for result in performance_results:
                print(
                    f"Performance Tests: {result.tests_passed}/{result.tests_run} passed"
                )
        ...
        for component in coverage_components:
            ...
            has_tests = any(
                component.split(" - ")[0].lower() in r.test_suite.lower()
        ...
        if failed_suites:
            ...
            for result in failed_suites:
                print(
                    f"   - Fix {result.test_suite}: {result.error_message[:100]}"
                )
        ...
        if partial_suites:
            ...
            for result in partial_suites:
                print(
                    f"   - Review {result.test_suite}: {result.tests_failed} tests failed"
                )

        if not failed_suites and not partial_suites:
            print(
                "✅ ALL TESTS PASSING - Core Analysis Engine test coverage is comprehensive"
            )
        ...
        print(
            "Detailed results saved to: core_analysis_engine_test_results.json"
        )
