...
class MockFilesystemAdvanced:
    ...
    def _create_standard_files(self):
        ...
        files = [
            ...
            (
                ...
                '{"version": "1.0.0", "debug": false, "max_panes": 4}',
            ),
            (
    ...
    def _create_special_case_files(self):
        ...
        special_files = [
            ...
            # Very long filename
            (
                "System/Temp/" + "very_long_filename_" * 5 + ".txt",
                "Long filename test",
            ),
    ...
    def _create_binary_files(self):
        ...
        binary_files = [
            ...
            (
                "Pictures/2023/vacation.jpg",
                b"\xff\xd8\xff\xe0\x00\x10JFIF" + b"fake_jpeg_data" * 100,
            ),
            (
                "Pictures/2023/family.png",
                b"\x89PNG\r\n\x1a\n" + b"fake_png_data" * 100,
            ),
            (
                "Pictures/2024/landscape.tiff",
                b"II*\x00" + b"fake_tiff_data" * 100,
            ),
            (
                "Pictures/Screenshots/screen1.bmp",
                b"BM" + b"\x00" * 52 + b"fake_bmp_data" * 100,
            ),
            # Audio files (fake headers)
            (
                "Music/Rock/song1.mp3",
                b"ID3\x03\x00\x00\x00" + b"fake_mp3_data" * 200,
            ),
            (
                "Music/Classical/symphony.flac",
                b"fLaC\x00\x00\x00\x22" + b"fake_flac_data" * 200,
            ),
            (
            ...
            (
                "Videos/tutorial.mp4",
                b"\x00\x00\x00\x20ftypmp42" + b"fake_mp4_data" * 300,
            ),
            (
                "Videos/presentation.avi",
                b"RIFF\x00\x00\x00\x00AVI LIST" + b"fake_avi_data" * 300,
            ),
            # Archive files (fake headers)
            (
                "Documents/Archive/backup.zip",
                b"PK\x03\x04" + b"fake_zip_data" * 150,
            ),
            (
                "Documents/Archive/old_project.tar.gz",
                b"\x1f\x8b\x08" + b"fake_tar_gz_data" * 150,
            ),
            (
                "Documents/Archive/archive.rar",
                b"Rar!\x1a\x07\x00" + b"fake_rar_data" * 150,
            ),
            # Executable files (fake headers)
            (
                "Development/Binary/app.exe",
                b"MZ\x90\x00" + b"fake_exe_data" * 250,
            ),
            (
                "Development/Binary/library.dll",
                b"MZ\x90\x00" + b"fake_dll_data" * 200,
            ),
            ...
            (
                ...
                b"PK\x03\x04" + b"fake_xlsx_data" * 200,
            ),
            (
                "Documents/presentation.pptx",
                b"PK\x03\x04" + b"fake_pptx_data" * 200,
            ),
        ]
...
class PerformanceMonitorAdvanced:
    ...
    def end_measurement(self, name: str) -> Dict[str, float]:
        ...
        result = {
            ...
            "memory_delta": self._get_memory_usage()
    ...
    def get_benchmark_results(self) -> Dict[str, Any]:
                        ...
                        results["threshold_violations"].append(
                            {
                                ...
                                "threshold": threshold,
                                "violation_ratio": result["duration"]
                                / threshold,
                            }
                        )
        ...
        if results["measurements"]:
            durations = [
                r["duration"] for r in results["measurements"].values()
            ]
    ...
    def assert_performance_threshold(
        self, name: str, max_duration: float = None
    ):
        """Assert performance meets threshold."""
        if (
            name not in self.measurements
            or "result" not in self.measurements[name]
        ):
...
class MemoryMonitorAdvanced:
    ...
    def get_memory_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            / (1024 * 1024),
            "memory_growth_rate": (
                memory_increase / len(self.memory_samples)
    ...
    def assert_memory_limit(self, max_increase_mb: int = 100):
        ...
        assert (
            memory_increase_mb <= max_increase_mb
