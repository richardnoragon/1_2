...
class MergTestRunner:
    ...
    def run_tests(self):
        ...
        pytest_cmd = [
            ...
            "pytest",
            "-c",
            f"pytest_merg_{self.date_stamp}.ini",
    ...
    def generate_execution_summary(self, return_code, stdout, stderr):
        ...
        with open(summary_file, "w") as f:
            ...
            f.write(
                f"Target: src.tools.pdf_tools.pdf_basic_operations.merg\\n"
            )
    ...
    def cleanup_old_results(self):
        ...
        for pattern in patterns:
            for file in os.listdir(self.test_dir):
                if file.startswith("result_merg_") and not file.endswith(
                    self.date_stamp
                ):
                    try:
    ...
    def run(self):
        ...
        final_summary = self.generate_execution_summary(
