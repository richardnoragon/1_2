...
class SimplePasswordGeneratorTestRunner:
    ...
    def run_tests(self):
        ...
        test_file = (
            self.test_dir / "test_simple_password_generator_2025-08-28.py"
        )
        config_file = (
            self.test_dir / "pytest_simple_password_generator_2025-08-28.ini"
        )
...
"""
        ...
        json_file = (
            self.test_dir
            / "result_simple_password_generator_summary_2025-08-28.json"
        )
    ...
    def run_complete_test_suite(self):
        ...
        if success:
            ...
            print(
                f"  - HTML Report: result_simple_password_generator_report_2025-08-28.html"
            )
            print(
                f"  - Coverage HTML: result_simple_password_generator_coverage_2025-08-28/"
            )
            print(
                f"  - Coverage JSON: result_simple_password_generator_coverage_2025-08-28.json"
            )
            print(
                f"  - JUnit XML: result_simple_password_generator_junit_2025-08-28.xml"
            )
            print(
                f"  - Summary: result_simple_password_generator_summary_2025-08-28.txt"
            )
        else:
