...
class MockErrorHandler:
    ...
    def handle_network_error(
        self, error: Exception, operation: str = "", target: str = ""
    ) -> bool:
        """
        ...
        return self.handle_error(
            error, context, ErrorSeverity.HIGH, ErrorCategory.NETWORK
        )

    def handle_security_error(
        self, error: Exception, security_context: str = ""
    ) -> bool:
        """
    ...
    def handle_validation_error(
        self, error: Exception, validation_type: str = ""
    ) -> bool:
        """
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        recent_errors = (
            self.errors[-10:] if len(self.errors) > 10 else self.errors
        )
